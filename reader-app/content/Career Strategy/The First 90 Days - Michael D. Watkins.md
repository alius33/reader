...
date: 2026-03-25
type: book-summary
tags: [book-summary, transitions, onboarding, leadership, first-90-days]
...
```mermaid
flowchart LR
    subgraph Wave1["First Wave (Days 1-90)"]
        A1[Learn] --> A2[Design] --> A3[Build Support] --> A4[Implement] --> A5[Observe]
    end
