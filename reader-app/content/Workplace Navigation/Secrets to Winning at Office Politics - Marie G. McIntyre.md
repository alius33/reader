...
date: 2026-03-25
type: book-summary
tags: [book-summary, politics, leverage, influence, self-management, power, adversary-management]
...
```mermaid
flowchart LR
    A[What You Contribute] --> E[Leverage Position]
    B[What the Org Needs] --> E
    C[How Replaceable You Are] --> E
    D[Who Supports You] --> E
    E --> F{Political Outcome}
...
```mermaid
flowchart LR
    A[Self-Observation] --> B[Self-Control]
    B --> C[Selective Behaviour]
    C --> D[Political Effectiveness]
    A --> D
...
```mermaid
flowchart TD
    A[Adversary Identified] --> B{Shared Goals Exist?}
    B -->|Yes| C[Conversion:<br>Structured Dialogue]
    B -->|No| D{Convertible Person?}
