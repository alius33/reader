...
date: 2026-03-28
type: book-summary
tags: [book-summary, parenting, islam, faith, eeman, fitrah, spiritual-development, islamic-education, child-development]
author: Aisha Hamdan
title: "Nurturing Eeman in Children"
year: 2013
---
...
```mermaid
flowchart TB
    Fitrah["Every child born with FITRAH<br/>(innate disposition toward Allah)"] --> Parents{"Parent's Role:<br/>Gardener, not Manufacturer"}
    Parents --> Part1["Part 1: FOUNDATIONS<br/>Aqeedah, Eeman, Ihsan<br/>Parenting as Amanah<br/>Knowledge & Fitrah"]
    Parents --> Part2["Part 2: SIX PILLARS<br/>Allah · Angels · Prophets<br/>Books · Resurrection · Qadar"]
    Parents --> Part3["Part 3: PERSONALITY<br/>Islamic Character<br/>Self-Esteem"]
    Parents --> Part4["Part 4: ENVIRONMENT<br/>Home · Peers · Community"]
    Part1 --> Result["Child with deeply rooted<br/>EEMAN and Islamic personality"]
    Part2 --> Result
    Part3 --> Result
    Part4 --> Result
```
...
```mermaid
flowchart TB
    Centre["Connecting a Child to Allah"] --> Love["LOVE<br/>Teach through His blessings,<br/>mercy, and generosity"]
    Centre --> Fear["FEAR (Taqwa)<br/>Awareness of His omniscience,<br/>justice, and accountability"]
    Centre --> Hope["HOPE<br/>His promises of reward,<br/>forgiveness, and paradise"]
    Centre --> Trust["TRUST (Tawakkul)<br/>Relying on Allah<br/>in all affairs"]
    Centre --> Gratitude["GRATITUDE (Shukr)<br/>Recognising and thanking<br/>for every blessing"]
    Centre --> Remembrance["REMEMBRANCE (Dhikr)<br/>Weaving awareness of Allah<br/>into daily life"]
```
...
```mermaid
flowchart LR
    Birth["Birth – Age 3<br/>Dhikr, Qur'an exposure,<br/>Arabic sounds, love of Allah,<br/>duas as daily habit"] --> PreSchool["Age 3 – 6<br/>Stories of prophets, angel awareness,<br/>short surah memorisation,<br/>gradual prayer introduction"]
    PreSchool --> School["Age 6 – 12<br/>Six pillars curriculum,<br/>Qur'an understanding,<br/>peer environment management,<br/>self-esteem building"]
    School --> Teen["Age 12+<br/>Deep aqeedah study,<br/>predestination & accountability,<br/>Islamic identity under pressure,<br/>community belonging"]
```
...
```mermaid
flowchart LR
    Morning["Morning<br/>Dua for waking<br/>Name of Allah<br/>Fajr prayer"] --> Day["During the Day<br/>Signs of Allah in nature<br/>Recording angels awareness<br/>Qur'an recitation"]
    Day --> Evening["Evening<br/>Prophetic story<br/>Family discussion<br/>Dua before sleeping"]
    Evening --> Weekly["Weekly<br/>Mosque attendance<br/>Family shura<br/>Community connection"]
    Weekly --> Ongoing["Ongoing<br/>Arabic language<br/>Qur'an memorization<br/>Character building"]
```
