...
date: 2026-03-27
type: book-summary
tags: [book-summary, parenting, autonomy, motivation, stress, anxiety, sense-of-control, neuroscience, adolescence, self-determination]
...
graph LR
    ...
    subgraph "Consultant Model"
        P2["Parent<br/>(Consultant)"] -->|"Informs, supports,<br/>expresses confidence"| C2["Child<br/>(Decision-maker)"]
...
graph TD
    ...
    G["Adolescence (13-17)"] -->|"Consult and support,<br/>step back further"| H["'I trust you to decide<br/>your course schedule'"]
    I["Young Adults (18+)"] -->|"Available when asked"| J["'I'm here if you<br/>want my input'"]
```
...
graph TD
    ...
    B --> E["Intrinsic Motivation<br/>Doing something because it<br/>matters to YOU"]
    C --> E
    D --> E
    E --> F["Flow States<br/>Optimal challenge + agency"]
```
...
graph TD
    ...
    B --> E["Community college →<br/>transfer"]
    B --> F["Skilled trades &<br/>apprenticeships"]
...
graph TD
    ...
    subgraph "The Solution"
        ...
        NAP["Nonanxious<br/>Presence"] --> SB["Home as<br/>Safe Base"]
        SB --> SOC
        SNN["Sleep + Exercise<br/>+ Meditation"] --> BH["Brain Health"]
        BH --> SOC
        RD["Radical<br/>Downtime"] --> DMN["Default Mode<br/>Network Activation"]
        DMN --> SOC
        SOC --> IM["Intrinsic<br/>Motivation"]
        IM --> FL["Flourishing"]
    end
```
...
```mermaid
mindmap
  root((Self-Driven<br/>Child))
    Sense of Control
      Say "It's your call"
      Offer informed choices
      Let natural consequences teach
      Respect their autonomy
    Consultant Model
      Ask "Whose problem is it?"
    ...
    Nonanxious Presence
      ...
      Accept reality (ACT)
    Brain Health
      Protect sleep (8-10 hours)
      Encourage exercise
      Value radical downtime
      Consider meditation
    School Navigation
      Resist early pushing
      Fight excessive homework
      Advocate for brain-friendly reform
      Support alternate routes
```
