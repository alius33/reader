...
date: 2026-03-27
type: book-summary
tags: [book-summary, parenting, communication, feelings, cooperation, punishment-alternatives, autonomy, praise, problem-solving, roles, Haim-Ginott]
...
```mermaid
flowchart LR
    Feel["Child Has<br/>a Feeling"] --> Deny{"Parent's<br/>Response"}
    Deny -->|"Deny, dismiss,<br/>fix, lecture"| Fight["Power Struggle<br/>Defiance, shutdown,<br/>escalation"]
    Deny -->|"Acknowledge,<br/>name, accept"| Connect["Connection<br/>Child feels heard<br/>Opens to cooperation"]
    Connect --> Skill["Apply Skills<br/>Cooperation, choices,<br/>problem-solving"]
    Skill --> Result["Better Behaviour<br/>More autonomy<br/>Stronger relationship"]
    Fight --> Cycle["Vicious Cycle<br/>More denial<br/>More defiance"]
```
...
```mermaid
flowchart TD
    Child["Child expresses<br/>a feeling"] --> Parent{"Parent's<br/>response?"}
    Parent -->|"Deny"| D["'You don't really<br/>feel that way'"]
    Parent -->|"Fix"| F["'Here's what<br/>you should do'"]
    Parent -->|"Question"| Q["'What did you<br/>do to cause it?'"]
    Parent -->|"Acknowledge"| A["'That sounds really<br/>frustrating'"]
    D --> Esc["Child escalates<br/>or shuts down"]
    F --> Esc
    Q --> Esc
    A --> Calm["Child feels heard<br/>Begins to think<br/>May solve own problem"]
```
...
```mermaid
flowchart TD
    Problem["A child does<br/>something wrong"] --> A["1. Express feelings<br/>strongly — without<br/>attacking character"]
    A --> B["2. State your<br/>expectations"]
    B --> C["3. Show how to<br/>make amends"]
    ...
    style D fill:#fdf8e8,stroke:#f39c12
    style E fill:#f0e8fd,stroke:#9b59b6
    style F fill:#e8fdfd,stroke:#1abc9c
```
...
```mermaid
flowchart LR
    Event["Child does<br/>something good"] --> Eval{"Type of<br/>praise?"}
    Eval -->|"Evaluative:<br/>'Good job!'"| Doubt["Child doubts<br/>Feels pressure<br/>Depends on judge"]
    Eval -->|"Descriptive:<br/>'I see you did X, Y, Z'"| Self["Child praises<br/>HIMSELF<br/>'I'm an artist!'"]
    Self --> Esteem["Genuine<br/>self-esteem"]
    Doubt --> Fragile["Fragile<br/>approval-seeking"]
```
...
```mermaid
flowchart TD
    Label["Child is labelled<br/>'the clumsy one'<br/>'the shy one'<br/>'the bully'"] --> Behave["Child begins<br/>ACTING the role"]
    Behave --> Confirm["Parents & others<br/>see confirmation<br/>of the label"]
    ...
    Overhear --> Storehouse["Remind of past<br/>finest moments"]
    Storehouse --> NewIdentity["Child begins<br/>to see herself<br/>DIFFERENTLY"]
```
...
```mermaid
flowchart TD
    Feel["1. FEELINGS<br/>Accept & name<br/>the child's emotions"] --> Coop["2. COOPERATION<br/>Describe, inform,<br/>use one-word cues"]
    Coop --> Alt["3. ALTERNATIVES<br/>Express, expect,<br/>problem-solve"]
    Alt --> Auto["4. AUTONOMY<br/>Offer choices,<br/>respect struggle"]
    ...
    style Auto fill:#fdf8e8,stroke:#f39c12
    style Praise fill:#f0e8fd,stroke:#9b59b6
    style Role fill:#e8fdfd,stroke:#1abc9c
```
...
```mermaid
flowchart TD
    Ginott["Dr. Haim Ginott<br/>Between Parent & Child<br/>(1965)"] --> FM["Faber & Mazlish<br/>How to Talk So Kids<br/>Will Listen (1980)"]
    FM --> JF["Joanna Faber<br/>How to Talk So<br/>Little Kids Will Listen"]
    FM --> Lansbury["Janet Lansbury<br/>No Bad Kids<br/>(RIE approach)"]
    FM --> Siegel["Daniel Siegel<br/>No-Drama Discipline &<br/>The Whole-Brain Child"]
