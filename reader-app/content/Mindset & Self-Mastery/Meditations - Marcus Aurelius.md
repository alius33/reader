...
date: 2026-03-25
type: book-summary
tags: [book-summary, stoicism, philosophy, self-mastery, resilience, wisdom]
...
```mermaid
flowchart LR
    subgraph up_to_you ["Within Your Control"]
        A["Your judgments"]
        B["Your actions"]
        C["Your character"]
        D["Your effort"]
    end
    subgraph not_you ["Not Within Your Control"]
        E["Other people's opinions"]
        F["External events"]
        G["Your reputation"]
        H["Your body's fate"]
    end
    style up_to_you fill:#27ae60,color:#fff
    style not_you fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart LR
    A["121 CE<br>Born in Rome"] --> B["138 CE<br>Adopted into<br>imperial succession"]
    B --> C["161 CE<br>Becomes Emperor<br>at age 40"]
    C --> D["165 CE<br>Antonine Plague<br>begins"]
    D --> E["170 CE<br>Begins writing<br>Meditations"]
    E --> F["175 CE<br>Cassius revolts"]
    F --> G["180 CE<br>Dies at<br>Vindobona"]
...
```mermaid
flowchart TD
    A["Marcus's Education"] --> B["Grandfather Verus<br>Temper, morals"]
    A --> C["Mother Domitia<br>Generosity, simplicity"]
    A --> D["Antoninus Pius<br>Mildness, consistency"]
    A --> E["Rusticus<br>Self-correction,<br>Epictetus"]
    A --> F["Apollonius<br>Rigour with warmth"]
    A --> G["Sextus<br>Tolerance, nature"]
    B --> H["The Philosopher-Emperor"]
    C --> H
    D --> H
    E --> H
    F --> H
...
```mermaid
flowchart TD
    A["Your Current Problem"] --> B["View from Above<br>(zoom out spatially)"]
    A --> C["Long Historical View<br>(zoom out temporally)"]
    B --> D["From space, your daily<br>frustrations are invisible"]
    C --> E["In 100 years, no one<br>will remember this"]
    D --> F["Perspective restored:<br>Is this worth your<br>emotional energy?"]
    E --> F
    F -->|Yes| G["Act with full commitment"]
    F -->|No| H["Release it. Move on."]
...
```mermaid
flowchart TD
    A["Someone wrongs you"] --> B["Remember their nature<br>(they act from ignorance)"]
    B --> C["Consider your own flaws<br>(you have erred similarly)"]
    C --> D["Remember impermanence<br>(both of you die soon)"]
    D --> E["Test the harm<br>(is your character damaged?)"]
    E -->|No| F["Release it"]
    E -->|Yes| G["Respond with virtue<br>(correct the situation justly)"]
    style A fill:#e74c3c,color:#fff
...
```mermaid
flowchart LR
    A["Event occurs"] --> B{"Your response"}
    B -->|Resistance| C["'This shouldn't<br>have happened'"]
    C --> D["Suffering<br>(fighting reality)"]
    B -->|Acceptance| E["'This happened.<br>Now what?'"]
    E --> F["Equanimity<br>(working with reality)"]
    B -->|Amor Fati| G["'This happened.<br>Good. What can I<br>make from it?'"]
    G --> H["Fuel<br>(using reality<br>as raw material)"]
...
```mermaid
flowchart TD
    A["The Good Life"] --> B["Wisdom<br>(Sophia)"]
    A --> C["Courage<br>(Andreia)"]
    A --> D["Justice<br>(Dikaiosyne)"]
    A --> E["Temperance<br>(Sophrosyne)"]
    B --> F["See clearly"]
    C --> G["Act rightly<br>despite cost"]
    D --> H["Treat others<br>fairly"]
    E --> I["Resist excess"]
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart TD
    A["The Stoic Life"] --> B["Discipline of<br>Perception"]
    A --> C["Discipline of<br>Action"]
    A --> D["Discipline of<br>Will"]
    B --> E["See things as<br>they truly are"]
    C --> F["Act for the<br>common good"]
    D --> G["Accept what you<br>cannot change"]
    E --> H["Techniques: testing<br>impressions, stripping<br>narrative"]
    F --> I["Techniques: morning<br>preparation, the<br>sage test"]
    G --> J["Techniques: amor fati,<br>memento mori, view<br>from above"]
    style A fill:#2980b9,color:#fff
    style B fill:#27ae60,color:#fff
    style C fill:#27ae60,color:#fff
    style D fill:#27ae60,color:#fff
