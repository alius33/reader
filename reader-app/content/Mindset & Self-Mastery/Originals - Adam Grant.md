...
date: 2026-03-25
type: book-summary
tags: [book-summary, creativity, originality, nonconformity, innovation, risk-taking, entrepreneurship, speaking-up, groupthink, coalition-building]
author: Adam Grant
...
```mermaid
flowchart LR
    A["Question<br>the Default"] --> B["Generate Ideas<br>at Volume"]
    B --> C["Select<br>& Test"]
    C --> D["Speak Up<br>Strategically"]
    D --> E["Build<br>Coalitions"]
    E --> F["Drive<br>Change"]
...
```mermaid
flowchart TD
    A["Creative Risk"] --> B["Keep Day Job<br>= Financial Safety"]
    A --> C["Quit Everything<br>= Maximum Pressure"]
    B --> D["Freedom to<br>Experiment"]
    B --> E["Can Survive<br>Failure"]
    D --> F["33% Lower<br>Failure Rate"]
    E --> F
    C --> G["Desperation<br>Drives Bad<br>Decisions"]
    C --> H["One Failure<br>= Total Loss"]
    G --> I["Higher<br>Failure Rate"]
    H --> I
    style F fill:#27ae60,color:#fff
...
```mermaid
flowchart TD
    A["Creator Has<br>an Idea"] --> B["Self-Evaluation"]
    A --> C["Peer Evaluation"]
    A --> D["Audience Testing"]
    B --> E["Biased by<br>IKEA Effect"]
    B --> F["Knowledge Curse<br>Inflates Value"]
    C --> G["Domain Expertise<br>+ Distance"]
    C --> H["Best Predictor<br>of Success"]
    D --> I["Penalises<br>Novelty"]
    D --> J["Rewards<br>Familiarity"]
...
```mermaid
flowchart TD
    A["Have an<br>Original Idea"] --> B{"Do You Have<br>Idiosyncrasy Credits?"}
    B -->|Yes| C["Speak Up<br>Directly"]
    B -->|No| D["Build Status<br>First"]
    D --> E["Demonstrate<br>Competence"]
    E --> F["Conform<br>Strategically"]
    F --> B
    C --> G["Lead with<br>Weaknesses"]
    G --> H["Invite<br>Collaboration"]
    H --> I["Idea Gets<br>Fair Hearing"]
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart LR
    A["Start Thinking<br>About Problem"] --> B["Step Away<br>(Incubation)"]
    B --> C["Zeigarnik Effect<br>Keeps Task Active"]
    C --> D["Encounter New<br>Stimuli"]
    D --> E["Unexpected<br>Connections"]
    E --> F["More Creative<br>Solution"]
    A --> G["Finish<br>Immediately"]
    G --> H["Most Obvious<br>Solution"]
    style F fill:#27ae60,color:#fff
...
```mermaid
flowchart TD
    A["Original Has<br>Radical Idea"] --> B["Frame in<br>Familiar Values"]
    B --> C["Build Coalition<br>of the Unlike"]
    C --> D["Use Mere<br>Exposure Effect"]
    D --> E["Idea Gains<br>Acceptance"]
    A --> F["Present in<br>Radical Form"]
    F --> G["Triggers<br>Resistance"]
    G --> H["Natural Allies<br>Fight Over<br>Tactics"]
    H --> I["Horizontal<br>Hostility"]
    I --> J["Movement<br>Stalls"]
...
```mermaid
flowchart TD
    A["Parenting Style"] --> B["Many Rules<br>Strict Obedience"]
    A --> C["Few Rules<br>Values + Reasoning"]
    B --> D["Rule-Followers"]
    C --> E["Values-Followers"]
    D --> F["Ask: What Am I<br>Supposed to Do?"]
    E --> G["Ask: What Is<br>the Right Thing?"]
    F --> H["Conformity"]
    G --> I["Originality"]
    style I fill:#27ae60,color:#fff
    style H fill:#e74c3c,color:#fff
...
```mermaid
flowchart TD
    A["Strong Culture"] --> B{"Does It Have<br>Dissent Mechanisms?"}
    B -->|Yes| C["Productive<br>Conflict"]
    B -->|No| D["Groupthink"]
    C --> E["Better<br>Decisions"]
    C --> F["Catches Blind<br>Spots Early"]
    D --> G["Suppressed<br>Warnings"]
    D --> H["Echo Chamber"]
    G --> I["Catastrophic<br>Failures"]
    H --> I
    E --> J["Sustained<br>Success"]
    F --> J
...
```mermaid
flowchart LR
    A["Anxiety"] -->|"Reappraise"| B["Excitement"]
    A -->|"Suppress"| C["Calm<br>(Very Difficult)"]
    B --> D["Better<br>Performance"]
    C --> E["Mixed<br>Results"]
    F["Anger"] -->|"Channel"| G["Strategic<br>Action"]
    F -->|"Unleash"| H["Alienation"]
    G --> D
    H --> I["Lost Allies"]
...
```mermaid
flowchart TD
    A["1. Question<br>the Default<br>(Vuja De)"] --> B["2. Generate Ideas<br>at Volume<br>(Simonton)"]
    B --> C["3. Select Ideas<br>Using Peers<br>(Berg)"]
    C --> D["4. Speak Up<br>Strategically<br>(Sarick Effect)"]
    D --> E["5. Time It Right<br>(Strategic<br>Procrastination)"]
    E --> F["6. Build<br>Coalitions<br>(Tempered<br>Radicalism)"]
    F --> G["7. Create Dissent<br>Cultures<br>(Nemeth)"]
    G --> H["8. Manage<br>Emotions<br>(Reappraisal)"]
    style A fill:#2980b9,color:#fff
    style H fill:#27ae60,color:#fff
```
