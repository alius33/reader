...
date: 2026-03-25
type: book-summary
tags: [book-summary, mindset, thinking, suffering, awareness, consciousness, inner-peace, spirituality, non-thinking, psychology]
...
flowchart LR
    subgraph Outside-In
        A1[Event Happens] --> A2[Creates Feeling]
        A2 --> A3[Determines Experience]
    end
    subgraph Inside-Out
        B1[Event Happens] --> B2[Thinking About Event]
        B2 --> B3[Creates Feeling]
        B3 --> B4[Determines Experience]
    end
...
```mermaid
flowchart TD
    A["Awareness<br>(The Observer)"] --> B["Thought arises"]
    A --> C["Thought passes"]
    A --> D["New thought arises"]
    A --> E["Thought passes"]
    A --> F["Space between thoughts"]
    B -.-> G["If believed:<br>Suffering"]
    B -.-> H["If observed:<br>Peace"]
...
```mermaid
flowchart TD
    A["Thinking"] --> B["Suffering<br>(anxiety, fear, doubt)"]
    B --> C["More Thinking<br>(analysis, rumination)"]
    C --> D["More Suffering<br>(deeper anxiety)"]
    D --> E["Even More Thinking<br>(why can't I fix this?)"]
    E --> F["Intensified Suffering"]
    F -->|"Cycle repeats"| A
...
```mermaid
flowchart TD
    A["Thought Arises"] --> B{"Do you engage?"}
    B -->|Yes: Follow, analyse, argue| C["More thoughts generated"]
    C --> D["Emotional reaction"]
    D --> E["Suffering persists"]
    E --> A
    B -->|No: Notice and release| F["Thought dissolves naturally"]
    F --> G["Clarity and peace"]
    G --> H["Wisdom or right action<br>emerges"]
...
```mermaid
flowchart TD
    A["Conscious Thinking<br>(Analysis, planning, rumination)"]
    B["Innate Wisdom<br>(Gut feeling, intuition,<br>creative insight)"]
    C["Loud, insistent,<br>often wrong"]
    D["Quiet, subtle,<br>often right"]
    A --> C
    B --> D
    E["When thinking is<br>loud..."] --> F["Wisdom is<br>drowned out"]
    G["When thinking<br>quiets..."] --> H["Wisdom becomes<br>audible"]
...
```mermaid
flowchart LR
    A["Past<br>(regret, shame,<br>resentment)"] -->|"Thoughts about"| C["Present Moment<br>(awareness, peace,<br>clarity)"]
    B["Future<br>(anxiety, worry,<br>dread)"] -->|"Thoughts about"| C
    C -->|"Without thinking"| D["Natural State<br>(peace, love, joy)"]
    C -->|"With thinking about<br>past or future"| E["Suffering"]
...
```mermaid
flowchart TD
    A["Event occurs<br>(neutral)"] --> B["Mind generates<br>thinking about event"]
    B --> C{"Do you believe<br>the thinking?"}
    C -->|"Yes"| D["Thought becomes<br>'reality'"]
    D --> E["Negative feeling<br>(compass alarm)"]
    E --> F["More thinking<br>(the trap)"]
    F --> D
    C -->|"No — you notice<br>and release"| G["Thought dissolves"]
    G --> H["Natural state:<br>peace, clarity, love"]
    H --> I["Innate wisdom<br>guides action"]
    I --> J["Clear, effective<br>response to event"]
    style A fill:#2980b9,color:#fff
    style F fill:#e74c3c,color:#fff
    style H fill:#27ae60,color:#fff
```
