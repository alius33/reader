...
date: 2026-03-25
type: book-summary
tags: [book-summary, character, morality, humility, virtue, self-mastery, biography, philosophy, eulogy-virtues, inner-life]
author: David Brooks
...
```mermaid
flowchart TD
    A["Adam I<br>(Career Self)"] --> C["Resume Virtues<br>Skills, status, achievement"]
    B["Adam II<br>(Moral Self)"] --> D["Eulogy Virtues<br>Courage, love, faithfulness"]
    C --> E["Modern Culture<br>favours Adam I"]
    D --> F["Character requires<br>cultivating Adam II"]
    E --> G["The Big Me<br>Self-promotion culture"]
    F --> H["The Road to Character<br>Struggle, humility, depth"]
...
```mermaid
flowchart LR
    A["Crooked Timber<br>Tradition"] --> B["Humans are<br>flawed"]
    B --> C["Struggle builds<br>character"]
    C --> D["External frameworks<br>needed"]
    D --> E["Eulogy<br>virtues"]
    F["Big Me<br>Culture"] --> G["Humans are<br>wonderful"]
    G --> H["Self-expression<br>is the goal"]
    H --> I["Internal compass<br>sufficient"]
    I --> J["Resume<br>virtues"]
...
```mermaid
flowchart LR
    A["Comfortable<br>upbringing"] --> B["Social reform<br>interest"]
    B --> C["Triangle Fire<br>(1911)"]
    C --> D["Summoned Self<br>activated"]
    D --> E["Decades of<br>reform work"]
    E --> F["Secretary of<br>Labour (1933)"]
    F --> G["Social Security,<br>minimum wage,<br>40-hour week"]
...
```mermaid
flowchart TD
    A["Dissolute youth<br>Drinking, affairs, abortion"] --> B["Birth of Tamar<br>(1927)"]
    B --> C["Overwhelming<br>gratitude"]
    C --> D["Conversion to<br>Catholicism"]
    D --> E["Loss of<br>Batterham"]
    E --> F["Catholic Worker<br>Movement (1933)"]
    F --> G["50 years of<br>voluntary poverty<br>and service"]
...
```mermaid
flowchart TD
    A["Disordered Loves<br>(pleasure, status, self<br>above all)"] --> B["Inner Conflict<br>(knowing the good,<br>unable to do it)"]
    B --> C["Moment of<br>Surrender"]
    C --> D["Grace<br>(external<br>transformation)"]
    D --> E["Ordered Loves<br>(right things in<br>right proportion)"]
    E --> F["Character<br>Depth"]
    style A fill:#e74c3c,color:#fff
...
```mermaid
flowchart TD
    A["The Big Me<br>Self-promotion,<br>self-expression"] -->|"Modern<br>culture"| B["Resume Virtues<br>Skills, status,<br>achievement"]
    C["The Humility Code<br>Self-confrontation,<br>self-transcendence"] -->|"Character<br>tradition"| D["Eulogy Virtues<br>Courage, love,<br>faithfulness"]
    B --> E["External Success<br>but inner<br>hollowness"]
    D --> F["Inner Depth<br>through lifelong<br>struggle"]
    style A fill:#e74c3c,color:#fff
...
```mermaid
flowchart LR
    A["Surface<br>Comfort"] --> B["Encounter with<br>Weakness / Crisis"]
    B --> C["Descent into<br>Struggle"]
    C --> D["Confrontation<br>with Self"]
    D --> E["Surrender /<br>Commitment"]
    E --> F["Slow Ascent<br>into Character"]
    style A fill:#2980b9,color:#fff
    style C fill:#e74c3c,color:#fff
    style F fill:#27ae60,color:#fff
```
