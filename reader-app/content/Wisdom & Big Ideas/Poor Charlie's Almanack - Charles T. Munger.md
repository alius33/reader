...
date: 2026-03-28
type: book-summary
tags: [mental-models, investing, psychology, wisdom, multidisciplinary-thinking, decision-making, behavioral-finance]
...
```mermaid
graph TD
    A[Mental Models Latticework] --> B[Mathematics]
    A --> C[Physics & Engineering]
    A --> D[Biology & Evolution]
    A --> E[Psychology]
    A --> F[Microeconomics]
    A --> G[Accounting]
    B --> B1[Compound interest]
    B --> B2[Permutations & combinations]
    B --> B3[Decision trees]
    C --> C1[Backup systems / redundancy]
    C --> C2[Breakpoints / critical mass]
    C --> C3[Feedback loops]
    D --> D1[Darwinian natural selection]
    D --> D2[Competitive destruction]
    D --> D3[Niche specialization]
    E --> E1[25 cognitive biases]
    E --> E2[Incentive superpower]
    E --> E3[Social proof]
    F --> F1[Advantages of scale]
    F --> F2[Competitive moats]
    F --> F3[Opportunity cost]
    G --> G1[Double-entry bookkeeping]
...
```mermaid
graph LR
    A[Start: $2M in 1884] --> B[Strong Trademark:<br>Coca-Cola]
    B --> C[Operant Conditioning:<br>Calories + Flavor +<br>Caffeine + Cooling]
    C --> D[Pavlovian Conditioning:<br>Associate with everything<br>consumers admire]
    D --> E[Social Proof:<br>Ubiquitous visibility<br>drives imitation]
    E --> F[Universal Distribution:<br>Available everywhere<br>on Earth]
    F --> G[Lollapalooza:<br>All forces compound<br>= $2 Trillion]
...
```mermaid
graph TD
    A[The Munger Code] --> B[1. Lifelong Learning]
    A --> C[2. Radical Honesty]
    A --> D[3. Extreme Reliability]
    A --> E[4. Inversion]
    A --> F[5. Multidisciplinary Thinking]
    A --> G[6. Patience + Decisiveness]
    A --> H[7. Avoid Stupidity]
    B --> B1["No wise people who<br>didn't read all the time"]
    C --> C1["Tell the truth, you won't<br>have to remember lies"]
    D --> D1["Reliability is essential<br>for progress in life"]
    E --> E1["Invert, always invert"]
    F --> F1["Know the big ideas<br>in the big disciplines"]
    G --> G1["Extreme patience + <br>extreme decisiveness"]
    H --> H1["Advantage comes from<br>not being stupid"]
...
```mermaid
graph TD
    M[Milgram Experiment] --> A[Authority-Misinfluence]
    M --> B[Social Proof from<br>inactive bystanders]
    M --> C[Commitment &<br>Consistency]
    M --> D[Doubt-Avoidance<br>under stress]
    M --> E[Deprival-Superreaction<br>sunk cost of compliance]
    M --> F[Reciprocation toward<br>the authority figure]
    A & B & C & D & E & F --> G[LOLLAPALOOZA:<br>Ordinary people deliver<br>torturing electric shocks]
...
```mermaid
graph TD
    S[Scale Advantages] --> W[Winner: Dominance]
    S --> L[Loser: Bureaucracy]
    W --> W1[Experience curve]
    W --> W2[TV advertising lock-out]
    W --> W3[Informational advantage]
    W --> W4[Social proof amplification]
    W --> W5[Winner-take-all cascades]
    L --> L1[Layers of management]
    L --> L2[Territorial behavior]
    L --> L3[Slow decisions]
    L --> L4[Paley syndrome:<br>killing the messenger]
    L --> L5[Niche competitors<br>outflanking from below]
    style W fill:#27ae60,color:white
...
```mermaid
mindmap
  root((Munger's<br>Worldly Wisdom))
    Mathematics
      Compound interest
      Probability theory
      Decision trees
