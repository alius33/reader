...
date: 2026-03-25
type: book-summary
tags: [book-summary, mastery, interviews, expertise, apprenticeship, creativity, mentorship, social-intelligence]
...
```mermaid
flowchart TD
    A[Success] --> B[Opaque: multiple factors, hard to isolate cause]
...
```mermaid
flowchart TD
    A[Craft Mastery] --> D[Raw Material]
    B[Discipline] --> D
    C[Social Intelligence] --> E[Whether material gets used or buried]
    D --> E
    E --> F[Recognised Mastery]
...
```mermaid
flowchart LR
    A[Ambition] -->|provides energy| C[Sustained Creative Output]
    B[Patience] -->|provides direction| C
    C --> D[Mastery]
