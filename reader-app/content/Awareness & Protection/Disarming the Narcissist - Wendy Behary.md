...
date: 2026-03-28
type: book-summary
tags: [narcissism, boundaries, relationships, schema-therapy, empathy, self-protection, interpersonal-neurobiology, communication, awareness]
author: Wendy Behary
...
confidence: ★★★★★ (clinical practitioner with 20+ years specialising in narcissism)
---
...
graph TD
    ...
    D --> E["<b>AUTHENTIC VOICE</b><br/>Respond from here-and-now<br/>wisdom, not there-and-then fear"]
...
graph TD
    ...
    subgraph "2. PREPARE"
        B --> C["Develop mindfulness<br/>practice"]
        C --> D["Learn the 4 masks<br/>and 5 bait-and-switch moves"]
    end
    subgraph "3. ACT"
        D --> E["Use the 4-stage process<br/>Observe→Assess→Identify→Differentiate"]
        E --> F["Deploy empathic<br/>confrontation"]
        F --> G["Create leverage<br/>+ set limits"]
    end
    subgraph "4. SUSTAIN"
        G --> H["Apply 7 communication<br/>gifts (FORCE)"]
        H --> I["Give positive feedback<br/>for genuine change"]
        I --> J{Is there progress?}
    end
    J -->|Yes| K["Continue building<br/>reciprocal relationship"]
    J -->|No| L["Consider professional<br/>help or exit"]
    style A fill:#2980b9,color:#fff
