...
date: 2026-03-28
type: book-summary
tags: [book-summary, emotional-neglect, childhood, psychology, self-help, healing, parenting, awareness, protection]
author: Jonice Webb
...
```mermaid
mindmap
  root((12 Parent Types))
    Control-Driven
      1. Narcissistic
      2. Authoritarian
      9. Achievement-Focused
      10. Sociopathic
...
```mermaid
flowchart TD
    CEN["Childhood Emotional<br/>Neglect"] --> E["1. Emptiness"]
    CEN --> CD["2. Counter-Dependence"]
    CEN --> USA["3. Unrealistic Self-Appraisal"]
    CEN --> NCS["4. No Compassion for Self"]
    CEN --> GS["5. Guilt & Shame"]
    CEN --> SDA["6. Self-Directed Anger"]
    CEN --> FF["7. The Fatal Flaw"]
...
```mermaid
flowchart LR
    S["Start<br/>Change"] --> P["Progress"]
    P --> SB["Setback"]
    SB -->|"Self-anger<br/>(enemy)"| Q["Quit"]
    SB -->|"Persistence<br/>(key)"| P
    P --> DC["Discomfort<br/>(alien feeling)"]
...
```mermaid
flowchart TD
    P1["Parents emotionally<br/>neglected as children"] --> B1["Blind spot about<br/>emotions"]
    B1 --> P2["Parent without<br/>emotional awareness"]
