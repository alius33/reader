...
date: 2026-03-28
type: book-summary
tags: [psychology, emotional-immaturity, recovery, parenting, boundaries, self-concept, emotional-autonomy, inner-world]
...
graph TD
    ...
    D --> E[Clear Mental Clutter]
    E --> F[Update Your Self-Concept]
    F --> G[Emotional Autonomy]
    G --> H[Better Relationships<br/>— starting with yourself]
...
graph LR
    subgraph "Emotional Coercions"
        ...
        G["Guilt<br/>→ Keeps you self-sacrificing"]
        S["Shame<br/>→ Annihilates selfhood"]
    end
    SD --> ET["Emotional<br/>Takeover"]
    F --> ET
    G --> ET
    S --> ET
    ET --> C["You become<br/>their caretaker"]
...
graph TD
    ...
    IS --> S["Survival Guidance<br/>— primal instincts under extreme duress"]
