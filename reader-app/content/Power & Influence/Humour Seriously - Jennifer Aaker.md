...
date: 2026-03-25
type: book-summary
tags: [book-summary, humour, levity, leadership, influence, creativity, resilience, culture, workplace, comedy, neuroscience, persuasion]
...
flowchart LR
    ...
    B --> C["Age 40<br/>300 laughs<br/>per 10 weeks"]
    B --> D["Workplace<br/>culture says:<br/>serious = competent"]
    D --> E["Suppression<br/>becomes habit"]
...
flowchart TB
    subgraph Expressive
        A["Stand-up<br/>Aggressive + Expressive"]
        B["Magnet<br/>Affiliative + Expressive"]
    end
    subgraph Subtle
        C["Sniper<br/>Aggressive + Subtle"]
        D["Sweetheart<br/>Affiliative + Subtle"]
    end
```
...
```mermaid
flowchart LR
    A[Levity<br/>Mindset] -->|channels into| B[Humour<br/>Skill]
    B -->|disciplines into| C[Comedy<br/>Profession]
    style A fill:#27ae60,color:#fff
...
```mermaid
flowchart TD
    L[Laughter] --> D[Dopamine<br/>Focus & Memory]
    L --> O[Oxytocin<br/>Trust & Bonding]
    L --> C[Cortisol Reduction<br/>Less Stress]
    L --> E[Endorphins<br/>Euphoria]
    D --> P[Power]
    O --> B[Bonds]
    C --> R[Resilience]
    D --> CR[Creativity]
...
```mermaid
flowchart LR
    T[Truth<br/>Shared reality] --> S[Setup<br/>Expected pattern]
    S --> P[Pivot<br/>Pattern breaks]
    P --> M[Misdirection<br/>Unexpected resolution]
    M --> L[Laughter]
...
```mermaid
flowchart TB
    G[Gravity<br/>Seriousness, focus,<br/>high stakes] <--> L[Levity<br/>Playfulness, openness,<br/>human connection]
    G --> E[Effectiveness]
    L --> E
    E --> T[Trust + Performance]
...
```mermaid
flowchart LR
    I[Instigators<br/>Rule-breakers who<br/>shake things up] --> C[Culture<br/>Carriers<br/>Rising stars who<br/>naturally use humour]
    C --> H[Hidden Gems<br/>Under-the-radar<br/>performers with<br/>surprising talents]
...
```mermaid
flowchart LR
    T[Truth<br/>Recognisable reality] --- P[Pain<br/>Discomfort or taboo]
    P --- D[Distance<br/>How far you are<br/>from the subject]
    T --- D
    style T fill:#27ae60,color:#fff
