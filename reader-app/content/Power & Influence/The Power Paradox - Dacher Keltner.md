...
date: 2026-03-25
type: book-summary
tags: [book-summary, power, influence, social-psychology, empathy, inequality, leadership, ethics]
...
```mermaid
flowchart TD
    A[Rise to Power] --> B[Focus on Others]
    B --> C[Empathy, Giving, Gratitude, Storytelling]
    C --> D[Enduring Influence]
    A --> E[Experience of Power]
    E --> F[Shift Focus to Self]
    F --> G[Empathy Deficits, Impulsivity, Incivility]
    G --> H[Fall from Power]
    H --> I[Powerlessness in Others]
    I --> J[Threat, Stress, Poor Health]
...
```mermaid
flowchart LR
    A[Alter Others' States] --> B[Present in Every Relationship]
    B --> C[Found in Everyday Actions]
    C --> D[Distributed Across Networks]
    D --> E[Empowering Others = Power]
...
```mermaid
flowchart TD
    A[Individual Acts] --> B{Greater Good Score}
    B -->|High| C[Good Reputation]
    B -->|Low| D[Targeted by Gossip]
    C --> E[Status & Esteem]
    E --> F[More Power]
    D --> G[Diminished Reputation]
    G --> H[Ostracism]
    H --> I[Loss of Power]
    F -->|If Abused| D
...
```mermaid
flowchart LR
    A[Empathy] --> E[Focus on Others]
    B[Giving] --> E
    C[Gratitude] --> E
    D[Storytelling] --> E
    E --> F[Trust & Strong Ties]
    F --> G[Enduring Power]
    E --> H[Neural Coupling & Mimicry]
    H --> F
...
```mermaid
flowchart LR
    A[Empathy] -->|Power Erodes| B[Empathy Deficits]
    C[Giving] -->|Power Erodes| D[Self-Serving Impulsivity]
    E[Gratitude] -->|Power Erodes| F[Incivility & Disrespect]
    G[Storytelling] -->|Power Erodes| H[Narratives of Exceptionalism]
    style A fill:#27ae60,color:#fff
...
```mermaid
flowchart TD
    A[Experience of Power] --> B[Attention Shifts to Self]
    B --> C[Empathy Deficits]
    B --> D[Self-Serving Impulsivity]
    B --> E[Incivility & Disrespect]
    B --> F[Narratives of Exceptionalism]
    C --> G[Loss of Moral Sentiments]
    D --> G
    E --> G
    F --> G
    G --> H[Fall from Power]
    H --> I[Others Experience Powerlessness]
    I --> J[Chapter 5 Consequences]
    style A fill:#2980b9,color:#fff
    style H fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart TD
    A[Powerlessness] --> B[Chronic Threat]
    B --> C[HPA Axis Activation]
    C --> D[Cortisol Release]
    D --> E[Immune Inflammation]
    D --> F[Brain Changes]
    D --> G[Fight-or-Flight]
    F --> H[Amplified Threat Sensitivity]
    H --> B
    E --> I[Disease & Shortened Life]
    G --> J[Undermined Contribution]
    D --> K[Suppressed Digestion & Reproduction]
...
```mermaid
flowchart TD
    A[Power Gained Through Greater Good] --> B[Experience of Power]
    B --> C[Empathy Deficits & Impulsivity]
    C --> D[Abuse of Power]
    D --> E[Others Experience Powerlessness]
    E --> F[Chronic Threat & Stress]
    F --> G[Poor Health & Cognitive Decline]
    G --> H[Reduced Capacity to Contribute]
    H --> I[Deeper Powerlessness]
    I --> J[Greater Inequality]
    J --> K[More Power for the Powerful]
    K --> B
    style A fill:#27ae60,color:#fff
...
```mermaid
flowchart TD
    A[Awareness] --> F[Enduring Power]
    B[Humility] --> F
    C[Giving] --> F
    D[Respect] --> F
    E[Changing Context] --> F
    F --> G[Greater Good Preserved]
    G --> H[Power Paradox Transcended]
