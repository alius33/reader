...
date: 2026-03-25
type: book-summary
tags: [book-summary, leadership, motivation, executive-leadership, organizational-health, team-management, meetings, communication, accountability, servant-leadership, Lencioni]
...
```mermaid
flowchart TD
    A["WHY DO YOU LEAD?"] --> B["Responsibility-Centred"]
    A --> C["Reward-Centred"]
    B --> D["Embraces uncomfortable<br>work willingly"]
    C --> E["Avoids uncomfortable<br>work unconsciously"]
    D --> F["Healthy Organisation"]
    E --> G["Dysfunctional Organisation"]
...
```mermaid
flowchart LR
    subgraph REWARD["Reward-Centred Leader"]
        direction TB
        R1["Status & prestige"]
        R2["Intellectual stimulation"]
        R3["Compensation & perks"]
        R4["Control & authority"]
        R5["Industry recognition"]
    end
    subgraph RESPONSIBILITY["Responsibility-Centred Leader"]
        direction TB
        S1["Team development"]
        S2["Difficult conversations"]
        S3["Repetitive communication"]
        S4["Meeting facilitation"]
        S5["Subordinate management"]
    end
    REWARD -->|"Gravitates toward"| FUN["Enjoyable work"]
    RESPONSIBILITY -->|"Gravitates toward"| HARD["Necessary work"]
    style REWARD fill:#e74c3c,color:#fff
    style RESPONSIBILITY fill:#27ae60,color:#fff
```
...
```mermaid
flowchart TD
    A["Top individual<br>performer"] --> B["Promoted to<br>leadership role"]
    B --> C["Sees role as<br>reward earned"]
    C --> D["Continues IC work:<br>strategy, analysis"]
    D --> E["Neglects leadership work:<br>team, management"]
    E --> F["Org suffers but<br>leader looks smart"]
    F --> G["Next top performer<br>promoted the same way"]
    G --> B
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart TD
    A["THE FIVE OMISSIONS"] --> B["1. Developing the<br>Leadership Team"]
    A --> C["2. Managing<br>Subordinates"]
    A --> D["3. Having Difficult<br>Conversations"]
    A --> E["4. Running Great<br>Meetings"]
    A --> F["5. Communicating<br>Repetitively"]
    B --> G["Team dysfunctions<br>persist"]
    C --> H["Underperformance<br>festers"]
    D --> I["Conflicts<br>metastasise"]
    E --> J["Decisions unmade<br>or unaligned"]
    F --> K["Employees confused<br>and disengaged"]
    style A fill:#2980b9,color:#fff
    style G fill:#e74c3c,color:#fff
...
```mermaid
flowchart LR
    A["Issue<br>Arises"] --> B["Week 1:<br>Minor correction"]
    A --> C["Month 6:<br>Serious intervention"]
    A --> D["Month 18:<br>Crisis / termination"]
    B --> E["Quick resolution<br>relationship intact"]
    C --> F["Resentment built<br>trust damaged"]
    D --> G["Silence = endorsement<br>betrayal felt"]
...
```mermaid
flowchart LR
    A["Bad Meetings"] --> B["Unresolved<br>Disagreements"]
    B --> C["Strategic<br>Misalignment"]
    C --> D["Confused<br>Execution"]
    D --> E["Poor Results"]
    F["Great Meetings"] --> G["Honest<br>Debate"]
    G --> H["Clear<br>Alignment"]
    H --> I["Coordinated<br>Execution"]
    I --> J["Strong Results"]
...
```mermaid
flowchart TD
    A["Neglect Team<br>Development"] --> B["No trust for<br>difficult conversations"]
    B --> C["Avoid managing<br>subordinates"]
    C --> D["Meetings become<br>empty rituals"]
    D --> E["Communication<br>breaks down"]
    E --> F["Organisation drifts:<br>confusion, politics,<br>turnover"]
    F -->|"Reinforces"| A
    style A fill:#e74c3c,color:#fff
    style F fill:#e74c3c,color:#fff
```
