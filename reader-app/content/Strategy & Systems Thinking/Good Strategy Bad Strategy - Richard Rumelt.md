...
date: 2026-03-28
type: book-summary
tags: [book-summary, strategy, competitive-advantage, decision-making, focus, leadership, systems-thinking, organizational-design, military-strategy, business-strategy]
...
graph TD
    ...
    D --> E{{"FOCUSED<br/>POWER"}}

    F["<b>BAD STRATEGY</b>"] --> G["💨 Fluff<br/>Buzzwords as insight"]
    F --> H["🙈 Ignore the Challenge<br/>No real diagnosis"]
    F --> I["🎯 Goals ≠ Strategy<br/>Wishes without plans"]
    F --> J["📋 Bad Objectives<br/>Dog's dinner lists"]
...
graph LR
    ...
    subgraph "THE KERNEL (Good)"
        A2["Diagnosis<br/>What's the challenge?"] --> B2["Guiding Policy<br/>How will we deal with it?"]
        B2 --> C2["Coherent Actions<br/>What specific moves?"]
    end
...
graph LR
    subgraph "CHAIN-LINK TRAP"
        ...
        B --> C["Link C<br/>Weak ❌"]
        C --> D["System Output<br/>Still Weak ❌"]
    end

    subgraph "CHAIN-LINK SOLUTION"
        E["Campaign 1<br/>Fix Quality"] --> F["Campaign 2<br/>Fix Sales"]
        F --> G["Campaign 3<br/>Fix Costs"]
        G --> H["System Output<br/>Excellent ✅"]
    end
...
graph LR
    ...
    D --> E["Opening for<br/>Upstarts"]
    E --> F["Upstart Wins with<br/>Tight Design"]
    F --> A
...
graph TD
    ...
    D --> E["Position Toward<br/>Attractor State"]
    E --> F{{"NEW COMPETITIVE<br/>LANDSCAPE"}}
    C --> G["Decline / Disruption"]
...
graph TD
    ...
    A --> E["👥 Panel of Experts<br/>Multiple perspectives"]
    A --> F["🧠 Anomaly Detection<br/>What doesn't fit?"]
    A --> G["⚖️ Independent Judgment<br/>Doubt consensus, not habitually"]
