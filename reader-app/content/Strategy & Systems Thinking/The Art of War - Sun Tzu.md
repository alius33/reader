...
date: 2026-03-28
type: book-summary
tags: [book-summary, strategy, warfare, leadership, military-strategy, classic, power, competitive-advantage, deception, intelligence]
author: Sun Tzu
...
graph TD
    ...
    B --> E["Five Constant Factors"]
    B --> F["Five Types of Spies"]
    B --> G["Know Enemy + Know Self"]
    C --> H["Speed Over Perfection"]
    C --> I["Impose Your Will"]
    C --> J["Seize the Initiative"]
    D --> K["All Warfare = Deception"]
    D --> L["Direct/Indirect Methods"]
    D --> M["Adapt Like Water"]
...
graph LR
    ...
    C --> MD["Method<br/>Discipline"]
    MD --> V{{"VICTORY<br/>or DEFEAT"}}

    style ML fill:#2980b9,color:#fff
    style H fill:#2980b9,color:#fff
    style E fill:#2980b9,color:#fff
    style C fill:#2980b9,color:#fff
    style MD fill:#2980b9,color:#fff
...
graph TD
    ...
    C --> E["Delivers the<br/>Decisive Blow"]
    D --> F["Enemy Prepares<br/>for Expected"]
    E --> G["Surprise Strikes<br/>Undefended Point"]
    F --> H{{"The roles REVERSE<br/>based on what<br/>the enemy expects"}}
    G --> H
    H --> A
...
graph TD
    ...
    A --> E["SURVIVING SPIES<br/>Bring Back Intelligence"]
    B --> F{{"COMPLETE<br/>INTELLIGENCE<br/>PICTURE"}}
    C --> F
    D --> F
    E --> F
...
graph LR
    ...
    E["Patience"] <--> F["Explosive Speed"]
    G["Obedience"] <--> H["Independence"]
    I["Caution"] <--> J["Boldness"]
    end
...
```mermaid
flowchart TD
    A["1. ASSESS<br/>Five Constant Factors"] --> B["2. CALCULATE<br/>Seven Diagnostic Questions"]
    B --> C{"Can we win<br/>without fighting?"}
    C -->|Yes| D["3a. STRATEGIC VICTORY<br/>Balk plans / Isolate / Pressure"]
    C -->|No| E["3b. PREPARE<br/>Intelligence + Deception"]
    E --> F["4. POSITION<br/>Terrain + Initiative"]
    F --> G["5. ENGAGE<br/>Cheng/Ch'i Combination"]
    G --> H["6. ADAPT<br/>Water Principle — No Constant Conditions"]
    H --> I{{"VICTORY"}}
    D --> I
