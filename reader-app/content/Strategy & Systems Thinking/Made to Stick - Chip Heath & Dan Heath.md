...
title: "Made to Stick"
year: 2007
category: "Strategy & Systems Thinking"
tags: [communication, persuasion, ideas, storytelling, framework, messaging]
reading-time: "55-65 min"
---
...
graph TB
    subgraph "Sony 1953"
        ...
        C --> D["1957: TR-55<br/>1.5M units sold"]
    end
    subgraph "NASA 1961"
        E["JFK's challenge:<br/><b>Man on the moon</b>"] --> F["Men don't walk<br/>on the moon"]
        F --> G["Tens of thousands<br/>coordinated for a decade"]
        G --> H["July 1969:<br/>Apollo 11 lands"]
    end
```
...
graph TD
    ...
    EX --> AUTH["Authorities"]
    EX --> ANTI["Antiauthorities"]
    IN --> DET["Vivid Details"]
    IN --> STAT["Statistics<br/>as relationships"]
    IN --> SIN["Sinatra Test"]
    AU --> TEST["Testable Credentials"]
```
...
graph TD
    ...
    CH --> CHE["Inspires perseverance<br/>and courage"]
    CN --> CNE["Inspires compassion<br/>and teamwork"]
    CR --> CRE["Inspires experimentation<br/>and new approaches"]
```
...
graph LR
    ...
    subgraph "Stage 2: TELLING OTHERS"
        B --> C["Transform using<br/>SUCCESs"]
        C --> D["Idea that<br/>STICKS"]
    end
    B -.->|"Curse of Knowledge<br/>makes this hard"| C
```
