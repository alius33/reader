...
date: 2026-03-28
type: book-summary
tags: [book-summary, parenting, islam, tarbiyah, child-development, faith-education, moral-education, islamic-parenting]
author: Abdullah Nasih Ulwan
title: "Child Education in Islam"
year: 1992
---
...
```mermaid
flowchart TB
    Marriage["Choose a Righteous Spouse<br/>(Tarbiyah Begins)"] --> Birth["Rights at Birth<br/>Adhan, Aqiqah, Good Name"]
    Birth --> SevenPillars["The Seven Pillars of Tarbiyah"]
    SevenPillars --> Faith["1. Faith<br/>Tawhid, Prayer, Quran,<br/>Muraqabat Allah"]
    SevenPillars --> Moral["2. Moral<br/>Honesty, Courage,<br/>Modesty, Kindness"]
    SevenPillars --> Physical["3. Physical<br/>Nutrition, Exercise,<br/>Health, Hygiene"]
    SevenPillars --> Intellectual["4. Intellectual<br/>Knowledge, Curiosity,<br/>Critical Thinking"]
    SevenPillars --> Psychological["5. Psychological<br/>Self-Confidence,<br/>Emotional Stability"]
    SevenPillars --> Social["6. Social<br/>Rights, Etiquette,<br/>Community Duty"]
    SevenPillars --> Sexual["7. Sexual<br/>Age-Appropriate Awareness,<br/>Modesty, Dignity"]
    Faith --> Methods["Five Methods of Education"]
    Methods --> Example["1. Example (Qudwa)"]
    Methods --> Habit["2. Habit ('Adah)"]
    Methods --> Admonition["3. Admonition (Maw'izah)"]
    Methods --> Observation["4. Observation (Mulahazah)"]
    Methods --> Punishment["5. Punishment ('Uqubah)<br/>(Last Resort Only)"]
    Punishment --> Goal["Goal: A Self-Regulating Adult<br/>Who Does Right Because<br/>They Understand Why"]
```
...
```mermaid
flowchart LR
    M1["1. EXAMPLE<br/>(Qudwa)<br/>Most Powerful"] --> M2["2. HABIT<br/>('Adah)<br/>Repetition Builds Character"]
    M2 --> M3["3. ADMONITION<br/>(Maw'izah)<br/>Stories & Counsel"]
    M3 --> M4["4. OBSERVATION<br/>(Mulahazah)<br/>Watchful Shepherding"]
    M4 --> M5["5. PUNISHMENT<br/>('Uqubah)<br/>Last Resort Only"]
...
```mermaid
flowchart TB
    Problem["Child Misbehaves"] --> Check1{"Have you modeled<br/>the right behavior?"}
    Check1 -->|No| Fix1["Fix your own example first"]
    Check1 -->|Yes| Check2{"Is the right habit<br/>established?"}
    Check2 -->|No| Fix2["Build the habit through<br/>consistent repetition"]
    Check2 -->|Yes| Check3{"Have you advised<br/>and counseled?"}
    Check3 -->|No| Fix3["Use stories, counsel,<br/>teachable moments"]
    Check3 -->|Yes| Check4{"Have you observed<br/>and monitored?"}
    Check4 -->|No| Fix4["Increase engaged presence,<br/>check influences"]
    Check4 -->|Yes| Check5{"Is the child 10+<br/>and all else tried?"}
    Check5 -->|No| Fix5["Return to methods 1-4<br/>with more patience"]
    Check5 -->|Yes| Last["Light, calm, purposeful<br/>correction — with explanation<br/>and reconnection after"]
    style Last fill:#e74c3c,color:#fff
```
