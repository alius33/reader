...
date: 2026-03-28
type: book-summary
tags: [book-summary, parenting, discipline, behavior-management, child-development, counting-method, toddler, practical-parenting]
...
```mermaid
flowchart TB
    subgraph Job1["JOB 1: Control Obnoxious Behavior"]
        Stop["STOP Behaviors<br/>(whining, arguing, tantrums,<br/>teasing, fighting)"]
...
flowchart LR
    ...
    J2 -.->|"Needs both<br/>orientations"| J1
```
