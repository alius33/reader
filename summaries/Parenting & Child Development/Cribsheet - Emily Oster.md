...
date: 2026-03-27
type: book-summary
tags: [book-summary, parenting, data-driven, economics, evidence-based, breastfeeding, sleep-training, vaccination, child-development, decision-making]
author: Emily Oster
title: "Cribsheet"
year: 2019
---
...
```mermaid
flowchart TB
    subgraph framework ["The Oster Decision Framework"]
        D["What does the<br/>DATA actually show?"]
        V["What are YOUR<br/>family's values &<br/>constraints?"]
        C["What's the right<br/>CHOICE for you?"]
    end
    D --> C
    V --> C
...
```mermaid
flowchart TB
    subgraph economist ["What an Economist Brings"]
        M["Methodological rigor<br/>(correlation ≠ causation)"]
        O["Opportunity cost<br/>(what else could you do?)"]
        P["Preference respect<br/>(your values matter)"]
    end
    M --> Better["Better-informed<br/>decisions"]
    O --> Better
    P --> Better
    Better --> Autonomy["Parental autonomy<br/>without guilt"]
```
...
```mermaid
flowchart TB
    Q["Parenting question<br/>(e.g., Should I breastfeed?)"]
    Q --> Step1["Step 1: DATA<br/>What does the research<br/>actually show?<br/>(Control for confounders,<br/>check study design,<br/>assess effect size)"]
    Step1 --> Step2["Step 2: YOUR SITUATION<br/>What are your family's<br/>specific constraints?<br/>(Work schedule, health,<br/>finances, support system,<br/>mental health)"]
    Step2 --> Step3["Step 3: YOUR VALUES<br/>What matters most<br/>to you?<br/>(Not what the internet<br/>says should matter)"]
    Step3 --> Decision["Informed decision<br/>you can feel good about"]
```
...
```mermaid
flowchart TB
    subgraph types ["Study Types: Strongest to Weakest"]
        RCT["Randomized Controlled Trial<br/>(Random assignment →<br/>can prove causation)"]
        QE["Quasi-experimental<br/>(Natural experiment →<br/>suggestive of causation)"]
        OBS["Observational Study<br/>(Compares groups →<br/>cannot prove causation)"]
        CASE["Case Reports / Anecdotes<br/>(Individual stories →<br/>cannot generalize)"]
    end
    RCT --> |"Strongest"| Conclusion["Confidence<br/>in conclusion"]
    QE --> |"Good"| Conclusion
    OBS --> |"Weak"| Conclusion
    CASE --> |"Very weak"| Conclusion
```
