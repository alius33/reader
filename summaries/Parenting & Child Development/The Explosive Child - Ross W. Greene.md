...
date: 2026-03-28
type: book-summary
tags: [book-summary, parenting, discipline, behaviour, problem-solving, collaboration, flexibility, frustration-tolerance, skills-deficit, explosive-behaviour]
...
```mermaid
flowchart TD
    A["Child exhibits challenging behaviour"] --> B{"Why?"}
    B --> C["Lagging skills:<br/>flexibility, frustration tolerance,<br/>problem-solving, emotion regulation,<br/>language processing, social cognition"]
    B --> D["Unsolved problems:<br/>specific, predictable situations<br/>where demands exceed skills"]
    D --> E{"How to respond?"}
    E -->|"Plan A"| F["Impose adult will<br/>⚡ Heightens explosions<br/>❌ Doesn't teach skills"]
    E -->|"Plan B"| G["Collaborate on solution<br/>1. Empathy step<br/>2. Define the Problem<br/>3. Invitation"]
    E -->|"Plan C"| H["Set aside for now<br/>Reduces explosions<br/>Preserves energy"]
    G --> I["Problem solved ✅<br/>Skills taught ✅<br/>Relationship rebuilt ✅"]
```
...
```mermaid
flowchart LR
    E["1. EMPATHY<br/>'I've noticed that...<br/>What's up?'<br/>→ DRILL for concern"] --> D["2. DEFINE THE PROBLEM<br/>'My concern is...'<br/>→ How it affects child<br/>→ How it affects others"]
    D --> I["3. INVITATION<br/>'I wonder if there's<br/>a way...'<br/>→ Realistic?<br/>→ Mutually satisfactory?"]
```
