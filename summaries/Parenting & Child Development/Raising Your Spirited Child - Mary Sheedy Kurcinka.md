...
date: 2026-03-28
type: book-summary
tags: [book-summary, parenting, temperament, spirited-child, child-development, emotional-regulation, sensitivity, persistence]
...
```mermaid
flowchart TD
    Spirit["SPIRITED CHILD<br/>Temperamentally 'more'"]
    Spirit --> Core["Five Core Traits"]
    Spirit --> Bonus["Four Bonus Traits"]
    Core --> I["Intensity<br/>Deep emotional reactions"]
    Core --> P["Persistence<br/>Won't give up"]
    Core --> S["Sensitivity<br/>Feels everything more"]
    Core --> Per["Perceptiveness<br/>Notices everything"]
    Core --> A["Adaptability<br/>Slow to transition"]
    Bonus --> R["Regularity<br/>Unpredictable rhythms"]
    Bonus --> E["Energy<br/>Constant motion"]
    Bonus --> FR["First Reaction<br/>Automatic 'No!'"]
    Bonus --> M["Mood<br/>Serious & analytical"]
    Core --> POWER["POWER Framework"]
    POWER --> Predict["Predict reactions"]
    POWER --> Organise["Organise the setting"]
    POWER --> Work["Work together"]
    POWER --> Enjoy["Enjoy the rewards"]
```
