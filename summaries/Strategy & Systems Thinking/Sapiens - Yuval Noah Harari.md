...
date: 2026-03-25
type: book-summary
tags: [book-summary, history, evolution, anthropology, cognitive-revolution, agricultural-revolution, scientific-revolution, human-nature, civilisation, imagined-orders, money, empire, religion]
...
```mermaid
flowchart LR
    A["Cognitive Revolution<br>~70,000 years ago"] --> B["Agricultural Revolution<br>~12,000 years ago"]
    B --> C["Scientific Revolution<br>~500 years ago"]
    A -.- D["Fictive language<br>Mass cooperation"]
    B -.- E["Population explosion<br>Imagined orders"]
    C -.- F["Ignorance + power<br>Global unification"]
...
```mermaid
flowchart TD
    A["Small groups<br>< 150 people"] --> B["Personal knowledge<br>Gossip"]
    C["Large groups<br>150+ people"] --> D["Shared myths<br>Imagined orders"]
    D --> E["Religions"]
    D --> F["Nations"]
    D --> G["Corporations"]
    D --> H["Legal systems"]
...
```mermaid
flowchart LR
    A["First Wave<br>Forager Expansion<br>~70,000-10,000 years ago"] --> B["Second Wave<br>Agricultural Expansion<br>~10,000-500 years ago"]
    B --> C["Third Wave<br>Industrial Activity<br>Ongoing"]
    A -.- D["Australian megafauna<br>American megafauna<br>Island species"]
    B -.- E["Madagascar elephant birds<br>Polynesian island species<br>Forest habitat destruction"]
    C -.- F["Whales, sharks, tuna<br>Rainforest species<br>Coral reef collapse"]
...
```mermaid
flowchart TD
    A["Objective reality<br>(radioactivity, gravity)"] -.-> D["Exists regardless<br>of belief"]
    B["Subjective reality<br>(imaginary friend, dream)"] -.-> E["Exists in one<br>person's mind"]
    C["Inter-subjective reality<br>(money, nations, rights)"] -.-> F["Exists in shared<br>imagination of millions"]
    style A fill:#2980b9,color:#fff
    style C fill:#27ae60,color:#fff
```
...
```mermaid
flowchart TD
    A["Chance historical event<br>(e.g., proximity to Africa)"] --> B["Legal discrimination<br>(slavery, Jim Crow)"]
    B --> C["Economic disadvantage<br>(poverty, lack of education)"]
    C --> D["Cultural stigma<br>('proof' of inferiority)"]
    D --> B
    style A fill:#2980b9,color:#fff
...
timeline
    ...
    section Cognitive Revolution
        70,000 BC : Fictive Language Emerges
        45,000 BC : Sapiens Reaches Australia
    section Agricultural Revolution
        10,000 BC : First Villages
        5,000 BC : First Cities and Writing
        3,000 BC : First Empires
    section Unification
        600 BC : First Coins (Lydia)
        0 AD : Christianity and Buddhism Spread
        1500 AD : European Empires Connect Globe
    section Scientific Revolution
        1500 AD : Discovery of Ignorance
        1776 AD : Capitalism as Creed
        2000 AD : Single Global Civilisation
```
...
```mermaid
flowchart TD
    A["Thousands of isolated worlds<br>10,000 BC"] --> B["Hundreds of cultures<br>2,000 BC"]
    B --> C["A few mega-cultures<br>AD 1450"]
    C --> D["One global civilisation<br>Today"]
    E["Money"] --> D
    F["Empire"] --> D
    G["Universal Religion"] --> D
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart LR
    A["Admit ignorance"] --> B["Observe & experiment"]
    B --> C["Gain new knowledge"]
    C --> D["Develop new powers"]
    D --> E["Fund more research"]
    E --> A
    style A fill:#2980b9,color:#fff
    style D fill:#27ae60,color:#fff
```
...
```mermaid
flowchart TD
    A["External event<br>(lottery, promotion, loss)"] --> B["Temporary spike or dip<br>in happiness"]
    B --> C["Hedonic adaptation<br>(brain adjusts)"]
    C --> D["Return to baseline<br>happiness level"]
    D --> E["New desire or fear<br>emerges"]
    E --> A
    style A fill:#2980b9,color:#fff
    style D fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart TD
    A["Natural Selection<br>4 billion years"] --> B["Cognitive Revolution<br>70,000 years ago"]
    B --> C["Agricultural Revolution<br>12,000 years ago"]
    C --> D["Scientific Revolution<br>500 years ago"]
    D --> E["Biotechnological Revolution<br>Now"]
    E --> F["Post-Sapiens Future<br>???"]
    style A fill:#2980b9,color:#fff
