...
date: 2026-03-28
type: book-summary
tags: [book-summary, communication, writing, structured-thinking, consulting, logic, problem-solving, presentations, mece, strategy]
...
graph TD
    ...
    B --> B1["Supporting<br/>argument"]
    B --> B2["Supporting<br/>argument"]
    C --> C1["Supporting<br/>argument"]
    C --> C2["Supporting<br/>argument"]
    D --> D1["Supporting<br/>argument"]
    D --> D2["Supporting<br/>argument"]
...
graph LR
    ...
    A --> P["<b>PYRAMID</b><br/>Supporting<br/>arguments"]
...
graph TD
    ...
    D --> E["4. What could we do?"]
    E --> F["5. What should we do?"]

    B --- G["Define the<br/>Problem"]
    C --- G
    D --- H["Find the<br/>Causes"]
    E --- I["Determine<br/>the Solution"]
    F --- I

    G --> J["Maps to SCQA<br/>Situation + Complication"]
    H --> K["Drives the<br/>Analysis"]
    I --> L["Becomes the<br/>Key Line"]
...
graph TD
    ...
    E["<b>MECE TEST</b>"] --> F["Mutually Exclusive?<br/>No overlaps between divisions"]
    E --> G["Collectively Exhaustive?<br/>All activities accounted for"]
