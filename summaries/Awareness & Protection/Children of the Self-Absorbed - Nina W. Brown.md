---
title: "Children of the Self-Absorbed"
author: Nina W. Brown
date: 2026-03-28
type: book-summary
category: "Awareness & Protection"
tags: [narcissism, self-absorbed-parents, adult-children, recovery, boundaries, self-development, emotional-healing]
...
```mermaid
quadrantChart
    title Four Self-Absorbed Parent Types
    x-axis "Covert" --> "Overt"
    y-axis "Demanding" --> "Engulfing"
    quadrant-1 "Grandstanding"
    quadrant-2 "Needy"
    quadrant-3 "Conniving"
    quadrant-4 "Prickly"
```
...
```mermaid
flowchart TD
    A["Initial Childhood Wound"] --> B["Repeated Empathic Failures"]
    B --> C["Negative Core Beliefs\n'I am flawed'"]
    C --> D["Vulnerability to Reinjury"]
    D --> E["Toxic Buildup"]
    E --> F["Self-Defeating Behaviors"]
    F --> C
    E --> G["🟢 INTERVENTION POINT\nBuild Essential Inner Self"]
    G --> H["Stronger Boundaries"]
    H --> I["Reduced Vulnerability"]
    I --> J["Healing & Growth"]
...
```mermaid
flowchart TD
    A["1. Build Awareness\nBecome mindful of what you experience in the moment"] --> B["2. Reduce Self-Absorption\nRecognize and change your own DNP traits"]
    B --> C["3. Increase Self-Reflection\nExamine thoughts, feelings, and behaviors constructively"]
    C --> D["4. Cultivate Strengths\nFind embedded strengths in perceived weaknesses"]
    D --> E["5. Build Strong Boundaries\nDefine where you end and others begin"]
    E --> F["6. Become Your Own Person\nChoose values, respect self and others, connect meaningfully"]
    style A fill:#3498db,color:#fff
