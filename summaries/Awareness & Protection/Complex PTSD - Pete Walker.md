...
date: 2026-03-28
type: book-summary
tags: [cptsd, trauma, recovery, inner-critic, emotional-flashback, 4f-types, grieving, reparenting, codependency, abandonment, psychology, awareness]
author: Pete Walker
title: "Complex PTSD: From Surviving to Thriving"
year: 2013
category: Awareness & Protection
book-type: manual/how-to
reading-time: 60-75 min
confidence: ★★★★★ (practising psychotherapist with 30+ years treating CPTSD; himself a survivor)
---
...
graph TD
    ...
    T --> F4["FAWN<br/>Codependent Defence"]
    F1 --> B1["Core belief:<br/>Power creates safety"]
    F2 --> B2["Core belief:<br/>Perfection creates safety"]
    F3 --> B3["Core belief:<br/>People = danger"]
    F4 --> B4["Core belief:<br/>Service creates safety"]
    B1 --> R1["Controls others<br/>through anger"]
    B2 --> R2["Flees pain through<br/>busyness & worry"]
    B3 --> R3["Numbs out &<br/>isolates completely"]
    B4 --> R4["Merges with others'<br/>needs & wishes"]
    style T fill:#e74c3c,color:#fff
    style F1 fill:#e67e22,color:#fff
    style F2 fill:#3498db,color:#fff
    style F3 fill:#95a5a6,color:#fff
...
graph LR
    ...
    subgraph "Variable Ratio"
        FL["Flight Type"]
    end
    subgraph "Outer Critic Dominant"
        FR["Freeze Type"]
        FI["Fight Type"]
    end
    style FA fill:#27ae60,color:#fff
    style FL fill:#3498db,color:#fff
    style FR fill:#95a5a6,color:#fff
...
graph TD
    ...
    G --> F["4. FEELING<br/>Passively working through grief"]
    A --> A1["Reclaims fight response<br/>Deconstructs repetition compulsion<br/>Sets boundaries against critic"]
    C --> C1["Gateway to self-compassion<br/>Softens the critic<br/>Releases hurt sadness cannot reach"]
    V --> V1["Speaking from feelings<br/>Heals abandonment<br/>Builds intimacy with safe others"]
    F --> F1["Somatic awareness<br/>Allows feelings to flow<br/>Advanced recovery practice"]
...
graph TD
    ...
    IC --> FF["4F<br/>Response"]
    FF -->|"Amplifies"| AD
    IC -->|"Amplifies"| FS
    style TR fill:#e74c3c,color:#fff
    style AD fill:#2c3e50,color:#fff
...
graph TD
    ...
    R --> SP["SPIRITUAL<br/>Gratitude<br/>Meaning<br/>Belonging"]
    R --> RE["RELATIONAL<br/>Safe vulnerability<br/>Reparenting by committee<br/>Earned secure attachment"]
    C --- E
    E --- SO
    SO --- SP
    SP --- RE
