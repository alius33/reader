...
```mermaid
graph LR
    A[Warmth] -->|"Target feels secure"| B[Withdrawal]
    B -->|"Target feels anxious"| C[Pursuit by Target]
    C -->|"Target invests emotionally"| D[Return of Warmth]
    D -->|"Relief = intensified pleasure"| E[Deeper Attachment]
    E -->|"Cycle repeats"| A
```
...
```mermaid
graph TD
    A[Inner Conviction] --> B[Projected Intensity]
    B --> C[Audience Response]
    C --> D[Amplified Energy]
    D --> B
    B --> E{6 Charismatic Types}
    E --> F[Authority<br/>Moses, de Gaulle]
    E --> G[Focus<br/>Joan of Arc]
    E --> H[Kindness<br/>Genuine warmth]
    E --> I[Eloquence<br/>MLK, Lenin]
    E --> J[Theatricality<br/>Drama + presence]
    E --> K[Uninhibitedness<br/>Elvis, Rasputin]
```
...
```mermaid
flowchart LR
    subgraph Hunger["Core Hungers"]
        A[Excitement<br/>Reformed Rake/Siren<br/>Drama Queen<br/>Novice]
        B[Validation<br/>Crushed Star<br/>Beauty<br/>Pampered Royal]
        C[Depth<br/>Disappointed Dreamer<br/>Professor<br/>Idol Worshiper]
        D[Connection<br/>Lonely Leader<br/>Rescuer<br/>Aging Baby]
        E[Freedom<br/>New Prude<br/>Exotic Fetishist<br/>Floating Gender]
        F[Innocence<br/>Roué<br/>Sensualist<br/>Conqueror]
    end
    Hunger --> G((Match Your<br/>Seductive Type<br/>to Their Void))
```
...
```mermaid
flowchart TD
    A[Observe Your Target] --> B{What Are They Missing?}
    B -->|Excitement| C[Reformed Rake/Siren<br/>Drama Queen<br/>Novice]
    B -->|Validation| D[Crushed Star<br/>Beauty<br/>Pampered Royal]
    B -->|Depth| E[Disappointed Dreamer<br/>Professor<br/>Idol Worshiper]
    B -->|Connection| F[Lonely Leader<br/>Rescuer<br/>Aging Baby]
    B -->|Freedom| G[New Prude<br/>Exotic Fetishist<br/>Floating Gender]
    B -->|Intensity| H[Roué<br/>Sensualist<br/>Conqueror]
    C --> I[Match With:<br/>Rake, Siren, Natural]
    D --> J[Match With:<br/>Ideal Lover, Charmer]
    E --> K[Match With:<br/>Ideal Lover, Charismatic]
    F --> L[Match With:<br/>Charmer, Natural]
    G --> M[Match With:<br/>Dandy, Coquette]
    H --> N[Match With:<br/>Siren, Coquette, Star]
```
...
```mermaid
graph LR
    subgraph P1["Phase 1: Separation"]
        A1[1. Choose Victim] --> A2[2. False Security]
        A2 --> A3[3. Mixed Signals]
        A3 --> A4[4. Create Triangles]
        A4 --> A5[5. Create Need]
        A5 --> A6[6. Insinuation]
        A6 --> A7[7. Enter Spirit]
        A7 --> A8[8. Create Temptation]
    end
    subgraph P2["Phase 2: Lead Astray"]
        B1[9. Suspense] --> B2[10. Words]
        B2 --> B3[11. Details]
        B3 --> B4[12. Poeticize]
        B4 --> B5[13. Weakness]
        B5 --> B6[14. Illusion]
    ...
    subgraph P3["Phase 3: Precipice"]
        C1[16. Prove Self] --> C2[17. Regression]
        C2 --> C3[18. Transgression]
        C3 --> C4[19. Spiritual Lures]
        C4 --> C5[20. Pain + Pleasure]
    end
    subgraph P4["Phase 4: Moving In"]
        D1[21. Space to Fall] --> D2[22. Physical Lures]
        D2 --> D3[23. Bold Move]
        D3 --> D4[24. Aftereffects]
    end
    P1 --> P2
    P2 --> P3
    P3 --> P4
...
```mermaid
graph TD
    A[Develop Seductive Character] --> B[Identify Victim Type]
    B --> C[Phase 1: Separation<br/>Steps 1-8]
    C --> D[Phase 2: Lead Astray<br/>Steps 9-15]
    D --> E[Phase 3: Precipice<br/>Steps 16-20]
    E --> F[Phase 4: Moving In<br/>Steps 21-24]
    F --> G{Outcome}
    G -->|Part Ways| H[Swift, Clean Break<br/>Preserve the Memory]
    G -->|Stay Together| I[Second Seduction Required<br/>Never Be Taken for Granted]
...
```mermaid
graph TD
    subgraph "Natural Pairings — Seducer → Victim"
        A[Siren] -->|seduces| B[Professor<br/>Conqueror<br/>Sensualist]
        C[Rake] -->|seduces| D[Disappointed Dreamer<br/>New Prude<br/>Lonely Leader]
        E[Ideal Lover] -->|seduces| F[Disappointed Dreamer<br/>Beauty<br/>Idol Worshiper]
        G[Coquette] -->|seduces| H[Conqueror<br/>Roué<br/>Pampered Royal]
        I[Charmer] -->|seduces| J[Lonely Leader<br/>Crushed Star<br/>Aging Baby]
        K[Charismatic] -->|seduces| L[Idol Worshiper<br/>Novice<br/>Floating Gender]
    end
```
...
```mermaid
graph LR
    subgraph Physical["Physical Pole"]
        A[Siren<br/>Pure physical<br/>presence]
        B[Rake<br/>Physical desire<br/>+ words]
    end
    subgraph Blended["Physical + Psychological"]
        C[Natural<br/>Childlike body<br/>+ innocence]
        D[Dandy<br/>Physical image<br/>+ ambiguity]
        E[Ideal Lover<br/>Appearance<br/>+ empathy]
    end
    subgraph Psychological["Psychological Pole"]
        F[Coquette<br/>Strategic<br/>absence]
        G[Charmer<br/>Emotional<br/>validation]
        H[Charismatic<br/>Inner<br/>conviction]
        I[Star<br/>Pure projected<br/>image]
    end
    A --> B --> C --> D --> E --> F --> G --> H --> I
```
...
```mermaid
graph TD
    subgraph "Classical Foundations"
        A[Ovid<br/>Art of Love<br/>~1 AD]
        B[Machiavelli<br/>The Prince<br/>1532]
        C[Sun Tzu<br/>Art of War<br/>~500 BC]
    end
    subgraph "Modern Psychology"
        D[Freud<br/>Psychoanalysis<br/>1900s]
        E[Cialdini<br/>Influence<br/>1984]
        F[Carnegie<br/>Win Friends<br/>1936]
    end
    subgraph "Greene Canon"
        G[48 Laws of Power<br/>1998]
        H["<b>Art of Seduction</b><br/><b>2001</b>"]
        I[Laws of Human Nature<br/>2018]
    end
    A --> H
    B --> G
    C --> G
...
```mermaid
graph LR
    A["Curiosity<br/>(Steps 1-3)"] --> B["Intrigue<br/>(Steps 4-6)"]
    B --> C["Fascination<br/>(Steps 7-8)"]
    C --> D["Confusion<br/>(Steps 9-12)"]
    D --> E["Dependency<br/>(Steps 13-15)"]
    E --> F["Overwhelm<br/>(Steps 16-19)"]
    F --> G["Surrender<br/>(Steps 20-23)"]
    G --> H["Aftermath<br/>(Step 24)"]
