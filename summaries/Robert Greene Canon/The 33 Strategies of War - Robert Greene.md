...
date: 2026-03-25
type: book-summary
tags: [book-summary, strategy, warfare, competition, leadership, tactics]
...
```mermaid
flowchart TD
    A[Strategic Vision<br>Single Directing Mind] --> B[Clear Intent<br>Communicated Down]
    B --> C[Division A<br>Autonomous Execution]
    B --> D[Division B<br>Autonomous Execution]
    B --> E[Division C<br>Autonomous Execution]
    C --> F[Convergence at<br>Point of Decision]
    D --> F
    E --> F
...
```mermaid
flowchart LR
    A[Strategy 1<br>Polarity] --> B[Strategy 2<br>Mental Fluidity]
    B --> C[Strategy 3<br>Presence of Mind]
    C --> D[Strategy 4<br>Death Ground]
    A -.- E[Name your<br>enemies]
    B -.- F[Drop past<br>patterns]
    C -.- G[Stay calm<br>under fire]
    D -.- H[Manufacture<br>urgency]
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart LR
    A[Advance Position] --> B[Shift Baseline]
    B --> C[Offer 'Concession']
    C --> D[Opponent Accepts<br>Worse Terms]
    D --> A
...
```mermaid
flowchart TD
    A[Strategic Communication] --> B[Frame the Narrative]
    A --> C[Select the Channel]
    A --> D[Time the Message]
    B --> E[Shape Perception]
    C --> E
    D --> E
    E --> F[Influence Decisions]
    style A fill:#2980b9,color:#fff
    style F fill:#27ae60,color:#fff
```
