...
date: 2026-03-28
type: book-summary
tags: [book-summary, trauma, ptsd, neuroscience, body, recovery, attachment, emdr, yoga, neurofeedback, developmental-trauma, dissociation]
...
```mermaid
flowchart TB
    T["TRAUMA"] --> B["Brain Rewired<br>Alarm system hyperactive<br>Rational brain offline"]
    T --> BO["Body Dysregulated<br>Chronic stress hormones<br>Muscle tension, pain, numbing"]
    T --> S["Self Shattered<br>Loss of agency<br>Dissociation, shame"]
    B --> R1["TOP-DOWN<br>Talk therapy, relationships<br>Understanding & narrative"]
    BO --> R2["BOTTOM-UP<br>Yoga, EMDR, movement<br>Theater, bodywork"]
    S --> R3["TECHNOLOGICAL<br>Neurofeedback, medication<br>Brain rewiring"]
    R1 --> H["RECOVERY<br>Restored sense of safety<br>Ownership of body & mind"]
    R2 --> H
    R3 --> H
...
```mermaid
flowchart LR
    subgraph brain ["THE TRIUNE BRAIN"]
        direction TB
        N["NEOCORTEX<br>(Rational Brain)<br>Language, planning,<br>abstract thought<br>~30% of brain"]
        L["LIMBIC SYSTEM<br>(Emotional Brain)<br>Amygdala, hippocampus<br>Emotions, memory,<br>danger detection"]
        R["BRAIN STEM<br>(Reptilian Brain)<br>Survival functions<br>Heart, lungs, sleep,<br>fight/flight/freeze"]
    end
    N --- L --- R
...
```mermaid
flowchart TB
    SAFE["SOCIAL ENGAGEMENT<br>(Ventral Vagal)<br>Safe, connected, curious<br>Eye contact, facial expression,<br>listening, speaking"] -->|threat detected| MOBILIZE["FIGHT / FLIGHT<br>(Sympathetic)<br>Adrenaline, heart racing,<br>muscles ready to act"]
    MOBILIZE -->|escape impossible| COLLAPSE["FREEZE / COLLAPSE<br>(Dorsal Vagal)<br>Shutdown, numbing,<br>dissociation, fainting"]
    style SAFE fill:#27ae60,color:#fff
    style MOBILIZE fill:#e67e22,color:#fff
...
```mermaid
flowchart TB
    SELF["THE SELF<br>(Curious, Calm, Compassionate)<br>Core healing agent"] --> M["MANAGERS<br>Control, prevent pain<br>Perfectionism, caretaking"]
    SELF --> E["EXILES<br>Hold trauma, shame, terror<br>Frozen in childhood"]
    SELF --> F["FIREFIGHTERS<br>Emergency response<br>Addiction, rage, numbing"]
    M -.->|"suppress"| E
    E -.->|"overwhelm triggers"| F
    F -.->|"temporarily block"| E
...
flowchart LR
    subgraph topdown ["TOP-DOWN"]
        TT["Talk Therapy<br>Narrative processing"]
        IFS2["IFS<br>Parts work, self-leadership"]
        PM["Psychomotor Therapy<br>Corrective experiences"]
    end
    subgraph bottomup ["BOTTOM-UP"]
        Y["Yoga<br>Body awareness, HRV"]
        EMDR2["EMDR<br>Memory reprocessing"]
        TH["Theater & Rhythm<br>Communal embodiment"]
    end
    subgraph tech ["TECHNOLOGICAL"]
        NF["Neurofeedback<br>Brain wave training"]
        MED["Medication<br>SSRIs, prazosin"]
    end
    topdown --> REC["RECOVERY<br>Ownership of body & mind<br>Fully alive in the present"]
    bottomup --> REC
    tech --> REC
    style REC fill:#27ae60,color:#fff
    style topdown fill:#2980b9,color:#fff
    style bottomup fill:#e67e22,color:#fff
    style tech fill:#9b59b6,color:#fff
```
...
```mermaid
flowchart TB
    subgraph P1 ["PART 1: DISCOVERY"]
        C1["Ch 1-3: Vietnam vets,<br>history of trauma science,<br>brain imaging revolution"]
    end
    subgraph P2 ["PART 2: MECHANISM"]
        C2["Ch 4-6: Triune brain,<br>polyvagal theory,<br>loss of body/self"]
    end
    subgraph P3 ["PART 3: CHILDREN"]
        C3["Ch 7-10: Attachment,<br>abuse/neglect, ACE study,<br>developmental trauma"]
    end
    subgraph P4 ["PART 4: MEMORY"]
        C4["Ch 11-12: Traumatic memory,<br>body memory,<br>recovered vs. false memory"]
    end
    subgraph P5 ["PART 5: RECOVERY"]
        C5["Ch 13-20: Talk therapy, EMDR,<br>yoga, IFS, psychomotor,<br>neurofeedback, theater"]
    end
    P1 --> P2 --> P3 --> P4 --> P5
