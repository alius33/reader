...
date: 2026-03-28
type: book-summary
tags: [book-summary, behavioral-economics, cognitive-bias, decision-making, irrationality, anchoring, free, social-norms, placebo, procrastination, dan-ariely]
author: Dan Ariely
...
flowchart TD
    ...
    PI --> P1["We decide by<br>comparison, not value"]
    PI --> P2["First impressions<br>anchor everything"]
    PI --> P3["Emotions rewrite<br>our preferences"]
    PI --> P4["Ownership changes<br>our perspective"]
    PI --> P5["We cheat — but<br>only a little"]
    P1 --> FIX["DESIGN BETTER<br>CHOICES"]
    P2 --> FIX
    P3 --> FIX
    P4 --> FIX
    P5 --> FIX
...
```mermaid
flowchart TD
    subgraph "How We Value Things"
        R["Relativity<br>We compare, never<br>evaluate in isolation"]
        A["Anchoring<br>First impressions<br>echo for years"]
        F["FREE!<br>Zero eliminates<br>perceived risk"]
        O["Ownership<br>Having it makes<br>it priceless"]
    end
    subgraph "How We Behave"
        SN["Social vs Market<br>Norms<br>Mixing them is<br>catastrophic"]
        AR["Arousal<br>Emotions rewrite<br>our values"]
        PR["Procrastination<br>Short-term always<br>beats long-term"]
        DO["Doors Open<br>Options feel more<br>valuable than outcomes"]
    end
    subgraph "How We Perceive"
        EX["Expectations<br>Beliefs create<br>reality"]
        PL["Placebo<br>Price changes<br>physiology"]
        DH["Dishonesty<br>Distance from cash<br>erodes morals"]
    end
    R --> A
    A --> F
    O --> DO
    ...
    style SN fill:#e74c3c,color:#fff
    ...
    style DH fill:#27ae60,color:#fff
```
