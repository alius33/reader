...
date: 2026-03-28
type: book-summary
tags: [book-summary, skin-in-the-game, risk, symmetry, ethics, ergodicity, minority-rule, nassim-taleb, incerto, decision-making]
...
```mermaid
flowchart TD
    SG["SKIN IN THE GAME<br>Personal exposure to<br>consequences"]
    SG --> E["ETHICS<br>Symmetry &<br>Silver Rule"]
    SG --> K["KNOWLEDGE<br>Learning through<br>consequences"]
    SG --> S["SURVIVAL<br>Ergodicity &<br>ruin avoidance"]
    SG --> R["RATIONALITY<br>What aids<br>survival"]
    E --> F1["Hammurabi → Kant<br>progression"]
    K --> F2["Via negativa<br>Systems learn<br>by removing"]
    S --> F3["Ensemble ≠ Time<br>probability"]
    R --> F4["Lindy effect<br>Time as judge"]
...
```mermaid
flowchart TD
    A["100 PEOPLE<br>Casino, one day"] --> B["~1% go bust<br>Others unaffected"]
    A --> C["'Expected return'<br>calculable from sample"]
    D["1 PERSON<br>Casino, 100 days"] --> E["Day 28: bust<br>No day 29 exists"]
    D --> F["100% probability<br>of eventual ruin"]
    B --> G["ENSEMBLE<br>PROBABILITY"]
    F --> H["TIME<br>PROBABILITY"]
    G -.- I["≠"]
    H -.- I
...
```mermaid
flowchart LR
    FR["Fooled by<br>Randomness<br>(2001)"] --> BS["The Black<br>Swan<br>(2007)"]
    BS --> AF["Antifragile<br>(2012)"]
    AF --> SG["Skin in the<br>Game<br>(2018)"]
    FR -.- T1["We mistake<br>luck for skill"]
    BS -.- T2["Rare events<br>shape the world"]
    AF -.- T3["Some things<br>gain from disorder"]
    SG -.- T4["Bearing consequences<br>is the foundation<br>of everything"]
    style SG fill:#2980b9,color:#fff
```
