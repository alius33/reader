...
tags: [lecture-summary, geo-strategy, saudi-arabia, iran, middle-east, proxy-wars, sunni-shia, wahhabism, mbs, trump, soleimani]
...
```mermaid
flowchart TB
    WAR["<b>US Invasion of Iran</b>"]
    F1["Force 1<br/>Israel Lobby &<br/>Christian Zionism<br/><i>Lecture 2</i>"]
    F2["Force 2<br/>Empire Economics &<br/>Petrodollar<br/><i>Lecture 3</i>"]
    F3["Force 3<br/>Saudi-Iran Rivalry &<br/>MBS-Trump Alliance<br/><i>Lecture 4</i>"]
    F1 --> WAR
    F2 --> WAR
    F3 --> WAR
...
```mermaid
flowchart LR
    subgraph Before["<b>Before 1979</b>"]
        A1["Both monarchies"]
        A2["Both secular"]
        A3["Both US-backed"]
        A4["Both oil exporters"]
        A5["Close allies"]
    end
    EQ["1979<br/>Islamic<br/>Revolution"]
    subgraph After["<b>After 1979</b>"]
        B1["Islamic Republic<br/>vs. Monarchy"]
        B2["Shia revolution<br/>vs. Wahhabi Sunni"]
        B3["Anti-US vs.<br/>US-dependent"]
        B4["Oil competitors"]
        B5["Bitter enemies"]
    end
    Before --> EQ --> After
...
```mermaid
flowchart LR
    A["610 AD<br/>Muhammad founds<br/>Islam in Medina"] --> B["Muhammad dies<br/>Succession crisis"]
    B --> C["Shia<br/><i>Bloodline only</i><br/>~10% of Muslims"]
    B --> D["Sunni<br/><i>Any faithful leader</i><br/>~88% of Muslims"]
    C --> E["Iran<br/>Shia state"]
    D --> F["Saudi Arabia<br/>Sunni state"]
    E --> G["Exporting Shia<br/>revolution"]
    F --> H["Exporting<br/>Wahhabism"]
    G --> I["Bitter<br/>rivalry"]
    H --> I
...
```mermaid
flowchart TB
    W["<b>Wahhabism</b><br/>Most extreme Sunni Islam"]
    W --> A["1744 Alliance<br/>with Al Saud family"]
    A --> N["National religion<br/>of Saudi Arabia"]
    N --> T["1930s: Oil wealth<br/>→ modernisation"]
    T --> C["Conflict with<br/>Wahhabis (20-40%)"]
    C --> S["Solution:<br/>Export Wahhabism"]
    S --> BL["Bin Laden in<br/>Afghanistan → al-Qaeda"]
    BL --> NINE["9/11: 15 of 19<br/>hijackers were Saudi"]
    NINE --> DAM["US-Saudi relations<br/>devastated"]
    style W fill:#2980b9,color:#fff
    style NINE fill:#e74c3c,color:#fff
    style DAM fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart TB
    R["<b>Saudi-Iran Rivalry</b>"]
    R --> D1["<b>Religious</b><br/>Sunni vs. Shia<br/>Wahhabism vs. Shia Revolution"]
    R --> D2["<b>Economic</b><br/>Oil production competition<br/>Dependent vs. diversified"]
    R --> D3["<b>Geopolitical</b><br/>Proxy wars<br/>Shipping lane control"]
    D1 -->|"Theological legitimacy<br/>funds militant exports"| D2
    D2 -->|"Oil wealth funds<br/>proxy groups"| D3
    D3 -->|"Proxy victories boost<br/>religious authority"| D1
...
```mermaid
flowchart TB
    subgraph PW1["<b>Iraq (2003+)</b>"]
        I1["Iran backs<br/>Shia majority (2/3)"]
        I2["Saudi finances<br/>Sunni minority (1/3)"]
        I1 --> IR1["<b>Iran wins</b>"]
        I2 --> IR1
    end
    subgraph PW2["<b>Syria (2011+)</b>"]
        S1["Iran + Russia<br/>back Assad"]
        S2["Saudi + US + Israel<br/>back rebels"]
        S1 --> IR2["<b>Iran wins</b>"]
        S2 --> IR2
    end
    subgraph PW3["<b>Yemen (2015+)</b>"]
        Y1["Houthis<br/>+ Iran support"]
        Y2["Saudi coalition<br/>150K troops, 30 nations"]
        Y1 --> IR3["<b>Saudi Arabia loses</b>"]
        Y2 --> IR3
    end
    IR1 --> F["Saudi Arabia loses<br/>every proxy war"]
    IR2 --> F
    IR3 --> F
    style IR1 fill:#e74c3c,color:#fff
    style IR2 fill:#e74c3c,color:#fff
    style IR3 fill:#e74c3c,color:#fff
...
```mermaid
flowchart TB
    SA["<b>Saudi Arabia</b><br/>Desert nation, no rivers"]
    SA --> OIL["<b>Oil Fields</b><br/>On the coast<br/>Fund 40% of GDP"]
    SA --> PORT["<b>Export Ports</b><br/>On the coast<br/>Ship oil to world"]
    SA --> DESAL["<b>Desalination Plants</b><br/>On the coast<br/>Only source of water"]
    DRONE["Houthi drones<br/>$1,000–$10,000"] -.->|"Can destroy"| OIL
    DRONE -.->|"Can destroy"| PORT
    DRONE -.->|"Can destroy"| DESAL
    IRAN["Iranian missiles"] -.->|"Can destroy"| OIL
    IRAN -.->|"Can destroy"| PORT
    IRAN -.->|"Can destroy"| DESAL
    OIL --> COLLAPSE["<b>Economic collapse</b>"]
    PORT --> COLLAPSE
    DESAL --> THIRST["<b>No drinking water</b>"]
    style SA fill:#2980b9,color:#fff
    style DRONE fill:#e74c3c,color:#fff
    style IRAN fill:#e74c3c,color:#fff
    style COLLAPSE fill:#e74c3c,color:#fff
    style THIRST fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart TB
    NINE["9/11 (2001)<br/>15 of 19 hijackers<br/>were Saudi"]
    NINE --> D1["Americans turn<br/>against Saudi Arabia"]
    IRQ["Iraq Invasion (2003)<br/>Saudi Arabia tried<br/>to stop it — failed"]
    IRQ --> D2["Iran fills the vacuum<br/>Saudi prediction<br/>comes true"]
    OB["Obama's Asia Pivot<br/>(2008–2015)"]
    OB --> D3["US resources shift<br/>to East Asia"]
    DEAL["Iran Nuclear Deal<br/>(2015)"]
    DEAL --> D4["US makes peace<br/>with Iran"]
    D1 --> DES["<b>Saudi Arabia<br/>is desperate</b>"]
    D2 --> DES
    D3 --> DES
    D4 --> DES
    DES --> MBS["MBS seizes the<br/>Trump opportunity"]
    style NINE fill:#e74c3c,color:#fff
    style DEAL fill:#e74c3c,color:#fff
    style DES fill:#e74c3c,color:#fff
    style MBS fill:#27ae60,color:#fff
```
...
```mermaid
flowchart LR
    MBS["<b>MBS</b><br/>Crown Prince"]
    MBS -->|"First foreign trip<br/>to Saudi Arabia"| T["<b>Trump</b><br/>President"]
    MBS -->|"Best friends<br/>+ $2B investment"| K["<b>Kushner</b><br/>Middle East Advisor"]
    K -->|"Son-in-law<br/>policy access"| T
    T -->|"Abraham Accords"| AA["Israel-Arab<br/>peace vs. Iran"]
    T -->|"Protects MBS"| KH["Khashoggi<br/>cover-up"]
    T -->|"Option 3"| SOL["Soleimani<br/>assassination"]
    AA --> GOAL["<b>Saudi Goal:</b><br/>US confrontation<br/>with Iran"]
    KH --> GOAL
    SOL --> GOAL
    style MBS fill:#2980b9,color:#fff
    style T fill:#2980b9,color:#fff
    style GOAL fill:#e74c3c,color:#fff
    style SOL fill:#e74c3c,color:#fff
```
