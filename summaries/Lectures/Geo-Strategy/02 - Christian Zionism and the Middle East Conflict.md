...
tags: [lecture-summary, geo-strategy, christian-zionism, israel-lobby, middle-east, religion-and-politics, eschatology]
...
```mermaid
flowchart TB
    A["Three Reasons the US<br/>Will Invade Iran"]
    A --> B["1. Defend the Empire<br/>(Lecture 1)"]
    A --> C["2. Ally Pressure<br/>(Saudi Arabia + Israel)"]
    A --> D["3. The Israel Lobby<br/>(THIS LECTURE)"]
    D --> E["Theological Foundation:<br/>Christian Zionism"]
...
```mermaid
flowchart LR
    A["Christianity:<br/>Revolutionary Religion<br/>for the Oppressed"] --> B["Official Religion<br/>of the Roman Empire"]
    B --> C["Contradiction:<br/>Revolution = Establishment"]
    C --> D["Augustine's<br/>Reinterpretation"]
    D --> E["Second Coming<br/>= Metaphor"]
    E --> F["Church Controls<br/>the Narrative"]
...
```mermaid
flowchart TB
    A["Catholic Church<br/>Controls the Bible"] --> B["The Reformation:<br/>Everyone Reads the Bible"]
    B --> C["Thousands of New<br/>Denominations in England"]
    C --> D["Dissenters:<br/>Bible Above the King"]
    D --> E["English Civil War<br/>(Puritans kill the king)"]
    E --> F["King Sends Dissenters<br/>to America"]
    F --> G["America Founded as<br/>a Christian Nation"]
    G --> H["Bible = Supreme<br/>Authority over all law"]
...
flowchart TB
    ...
    Q --> AM["Amillennialism<br/>(Augustine)"]
    Q --> HP["Historic<br/>Premillennialism"]
    Q --> PO["Postmillennialism"]
    Q --> DP["Dispensationalist<br/>Premillennialism"]
    AM --> AM1["It's a metaphor.<br/>The Church handles it."]
    HP --> HP1["It's a promise.<br/>Trust God. Be patient."]
    PO --> PO1["Build 1000 years of<br/>Christian civilisation first."]
    DP --> DP1["It's a PLAN.<br/>Follow the roadmap."]
    DP1 --> WAR["Promote Middle East<br/>conflict to fulfil prophecy"]
    style Q fill:#2980b9,color:#fff
    style DP fill:#e74c3c,color:#fff
    style WAR fill:#e74c3c,color:#fff
    style AM fill:#555,color:#fff
    style HP fill:#555,color:#fff
    style PO fill:#555,color:#fff
```
...
```mermaid
flowchart TB
    A["Dispensationalist<br/>Premillennialism"] --> B["Theologically<br/>Rejected by Mainstream"]
    A --> C["Most Organised<br/>Christian Group"]
    A --> D["Most Fanatical<br/>Believers"]
    A --> E["Grows Under<br/>Inequality + Instability"]
    B --> F["Irrelevant:<br/>Fanatics outcompete<br/>the passive majority"]
    C --> F
    D --> F
    E --> G["Worsening Conditions =<br/>Growing Membership"]
    F --> H["Active Political<br/>Force Promoting War"]
    G --> H
    style A fill:#2980b9,color:#fff
    style B fill:#555,color:#fff
...
```mermaid
flowchart LR
    A["Israel Reconstituted<br/>as Jewish Nation<br/>(1948 ✅)"] --> B["Temple Rebuilt<br/>in Jerusalem<br/>(not yet)"]
    B --> C["Antichrist<br/>Appears"]
    C --> D["All Nations<br/>Attack Israel"]
    D --> E["Jesus Returns,<br/>Destroys Antichrist"]
    E --> F["1000 Years<br/>of Peace"]
    F --> G["Last<br/>Judgement"]
    style A fill:#27ae60,color:#fff
...
```mermaid
flowchart LR
    A["Christian Zionism<br/>(~200 years ago)"] --> B["Zionism<br/>(initially unpopular<br/>among Jews)"]
    B --> C["Holocaust<br/>(1940s)"]
    C --> D["Mass Migration<br/>to Palestine"]
    D --> E["Israel Established<br/>(1948)"]
    E --> F["Dispensationalists:<br/>'Step 1 Complete'"]
    F --> G["Push for<br/>More Middle East Conflict"]
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart TB
    CZ["Christian Zionism<br/>(Dispensationalist Theology)"] --> US["US Foreign Policy:<br/>'Religious duty to protect Israel'"]
    CZ --> IL["Israel's Calculation:<br/>'America will fight our wars'"]
    US --> WAR["Middle East Conflict"]
    IL --> WAR
    WAR --> PROPH["Prophecy Advances:<br/>Dispensationalists Vindicated"]
    PROPH --> MORE["More Believers,<br/>More Political Pressure"]
    MORE --> CZ
    style CZ fill:#2980b9,color:#fff
    style WAR fill:#e74c3c,color:#fff
    style PROPH fill:#555,color:#fff
```
...
```mermaid
flowchart TB
    subgraph PR ["Pax Romana (2000 years ago)"]
        A1["Roman Peace<br/>(No Wars)"] --> B1["No Social Mobility"]
        B1 --> C1["Massive Inequality"]
        C1 --> D1["Hopelessness Among<br/>Slaves & Peasants"]
        D1 --> E1["Christianity:<br/>Free Lottery Ticket"]
    end
    subgraph PA ["Pax Americana (today)"]
        A2["American Peace<br/>(70 Years)"] --> B2["No Social Mobility"]
        B2 --> C2["Billionaires +<br/>Delivery Drivers"]
        C2 --> D2["Millions Feel<br/>Life is Pointless"]
        D2 --> E2["Dispensationalism:<br/>Free Lottery Ticket"]
    end
