...
tags: [lecture-summary, geo-strategy, american-politics, trump, elections, coalition-politics, suburban-swing]
...
```mermaid
flowchart LR
    L1["Lecture 1<br/>Iran fights<br/>asymmetrically"]
    L2["Lecture 2<br/>Christian Zionism<br/>Force 1"]
    L3["Lecture 3<br/>Empire economics<br/>Force 2"]
    L4["Lecture 4<br/>Saudi desperation<br/>Force 3"]
    L5["Lecture 5<br/>Who will be<br/>president?"]
    L6["Lecture 6<br/>How America<br/>fights Iran"]
    L1 --> L2 --> L3 --> L4 --> L5 --> L6
...
```mermaid
flowchart LR
    H["Headline<br/>Biden 81M vs Trump 74M<br/>Looks like a landslide"]
    R["Reality<br/>65,000 votes<br/>in battleground states"]
    I["Implication<br/>Small demographic shifts<br/>flip the election"]
    H --> R --> I
...
```mermaid
flowchart TB
    V["Biden's 2020 Victory<br/>65,000-vote margin"]
    B["Black Voters<br/>91% Biden<br/>2024: Eroding"]
    Y["Young People<br/>Galvanised by<br/>George Floyd<br/>2024: Abstaining"]
    C["College-Educated<br/>70% Biden<br/>2024: Less enthusiastic"]
    W["Women<br/>54% Biden<br/>2024: Holding"]
    S["Suburban Voters<br/>54% Biden<br/>2024: Up for grabs"]
    V --- B
    V --- Y
    V --- C
    V --- W
...
```mermaid
flowchart TB
    subgraph "Three Mechanisms — Suburbs Flip to Biden 2020"
        M1["Media Narrative<br/>Trump = divisive<br/>George Floyd +<br/>'send in the military'"]
        M2["Pandemic<br/>Suburban anxiety<br/>Trump incompetent<br/>in crisis"]
        M3["Kamala Harris<br/>'Like us' + Tough on crime<br/>+ Redemption narrative"]
    end
    M1 --> FLIP["Suburbs flip<br/>45% to 54%<br/>Biden wins"]
    M2 --> FLIP
    M3 --> FLIP
    M3 -.- KEY["Most replicable<br/>mechanism"]
    style M1 fill:#2980b9,color:#fff
    style M2 fill:#2980b9,color:#fff
    style M3 fill:#27ae60,color:#fff
    style FLIP fill:#27ae60,color:#fff
    style KEY fill:#f9e79f,color:#333
```
...
```mermaid
flowchart TB
    subgraph "Biden-Harris Template 2020"
        BW["Biden's Weakness<br/>Old, white, male,<br/>out of touch"]
        HS["Harris as Antidote<br/>Black, Indian, female,<br/>young, sharp, former attacker"]
        BW --> HS
    end
    subgraph "Trump-Haley Template 2024"
        TW["Trump's Weakness<br/>Divisive, immature,<br/>hostile to women"]
        NH["Haley as Antidote<br/>Female, minority, suburban,<br/>centrist, former attacker"]
        TW --> NH
    end
    HS --> R1["Suburbs flip<br/>Biden wins"]
    NH --> R2["Suburbs flip<br/>Trump wins"]
    style BW fill:#e74c3c,color:#fff
    style TW fill:#e74c3c,color:#fff
    style HS fill:#27ae60,color:#fff
    style NH fill:#27ae60,color:#fff
...
```mermaid
flowchart TB
    subgraph "What the Public Sees"
        P1["Haley: 'Trump is<br/>divisive, we need<br/>to move on'"]
        P2["Trump: 'She's a<br/>bird brain'"]
        P3["'No way they<br/>work together'"]
        P1 --> P3
        P2 --> P3
    end
    subgraph "What's Behind the Curtain"
        R1["2016-2018:<br/>Got along well<br/>as allies"]
        R2["Trump considered<br/>Haley for VP<br/>in 2020"]
        R3["Both are<br/>pure opportunists"]
    end
    P3 --> PICK["August: Trump<br/>picks Haley"]
    R1 -.-> PICK
    R2 -.-> PICK
    R3 -.-> PICK
    PICK --> RESULT["'He's a changed man'<br/>Suburbs switch<br/>Trump wins"]
    style P1 fill:#e74c3c,color:#fff
    style P2 fill:#e74c3c,color:#fff
    style RESULT fill:#27ae60,color:#fff
    style PICK fill:#2980b9,color:#fff
```
...
```mermaid
flowchart TB
    H["Nikki Haley<br/>$0 in 2018 to<br/>$10M + $5M mansion"]
    U["United Against<br/>a Nuclear Iran<br/>Anti-Iran lobby"]
    B["Boeing Board<br/>$300K salary<br/>Weapons manufacturer"]
    C["Christians United<br/>for Israel<br/>7M evangelicals"]
    A["Sheldon Adelson<br/>Netanyahu's patron<br/>Casino billionaire"]
    U --> H
    B --> H
    C --> H
    A -->|"funds"| U
    H --> VP["VP Role:<br/>Agitate for war<br/>against Iran"]
    style H fill:#2980b9,color:#fff
...
```mermaid
flowchart TB
    W["Biden wins 2020<br/>by accident<br/>George Floyd +<br/>pandemic"]
    W --> L["Learns wrong lesson:<br/>'Passivity works'"]
    L --> S["2024 strategy:<br/>'I'm not Trump'<br/>+ sit in basement"]
    S --> P["Problem: both<br/>candidates now 'suck'"]
    P --> LOW["Low turnout<br/>more passionate<br/>base wins"]
    LOW --> T["Republican base<br/>more passionate<br/>Trump wins"]
    T -.->|"Cannot break cycle"| AGE["Biden is 81<br/>No energy to<br/>change"]
    AGE -.-> S
    style W fill:#27ae60,color:#fff
...
```mermaid
flowchart TB
    D["Data<br/>Coalition numbers,<br/>suburban voting,<br/>donor flows"]
    M["Analytical Model<br/>How elections<br/>actually work"]
    P["Testable Prediction<br/>Trump wins,<br/>picks Haley"]
    R["Reality<br/>August convention,<br/>November election"]
    REF["Refinement<br/>Where was the<br/>model wrong?"]
    D --> M --> P --> R
    R -->|"If wrong"| REF
    REF -->|"Update"| M
    R -->|"If right"| NEXT["Apply to<br/>next question"]
