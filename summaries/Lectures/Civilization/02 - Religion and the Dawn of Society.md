...
tags: [lecture-summary, civilization, religion, animism, cave-paintings, shamans, ice-age, mother-goddess, symbols]
...
```mermaid
flowchart LR
    A["Africa<br/>300,000 ya"] -->|"Cold drives<br/>migration<br/>~100,000 ya"| B["Europe"]
    B --> C["Asia"]
    C --> D["Bering Strait<br/>(ice bridge)"]
    D --> E["Americas"]
    C --> F["Australia"]
    B --> CP1["Chauvet Cave<br/>~30,000 ya"]
    B --> CP2["Altamira<br/>~34,000 BCE"]
    B --> CP3["Lascaux<br/>~20,000 ya"]
...
```mermaid
flowchart TB
    CP["Cave Paintings<br/>found where<br/>acoustics were best"]
    CP --> Music["Musical instruments<br/>(flutes) found<br/>alongside paintings"]
    CP --> Dark["Total darkness<br/>animal fat lamps<br/>flickering light"]
    Music --> Fest["Religious Festival:<br/>music + dance +<br/>visual ritual"]
    Dark --> Fest
    Fest --> Exp["Total sensory<br/>experience"]
    Exp --> Spirit["Perceived contact<br/>with spirit world"]
    Fest --> GT["Same pattern as<br/>Gobekli Tepe<br/>20,000 years later"]
    style CP fill:#2980b9,color:#fff
    style Fest fill:#27ae60,color:#fff
    style Spirit fill:#27ae60,color:#fff
```
...
```mermaid
flowchart TB
    SW["Spirit World<br/>(souls, stars,<br/>other worlds)"]
    SW -->|"Soul enters via<br/>womb (darkness to light)"| Life["Life in Our World"]
    Life -->|"Soul returns via<br/>burial (light to darkness)"| SW
    Cave["Cave = Nature's Womb<br/>(permanent portal)"]
    Cave ---|"Connects both<br/>worlds"| SW
    Cave ---|"Ritual access<br/>point"| Life
    Life --> Kill["Animal killed<br/>for food"]
    Kill --> Return["Soul returns to<br/>Spirit World"]
    Return --> Ritual["Cave ritual:<br/>summon soul back"]
    Ritual --> Life
    style SW fill:#2980b9,color:#fff
    style Cave fill:#2980b9,color:#fff
    style Ritual fill:#27ae60,color:#fff
...
```mermaid
flowchart TB
    MG["Mother Goddess<br/>(gives life to all)"]
    MG --> H["Humans"]
    MG --> An["Animals"]
    MG --> T["Trees &<br/>Plants"]
    MG --> All["All Living<br/>Things"]
    H --- BH["Balance &<br/>Harmony"]
    An --- BH
    T --- BH
    All --- BH
    BH --> Cycle["World as Cycle<br/>(circle, river --<br/>NOT pyramid)"]
    Kill["Kill for food"] --> Forgive["Ask forgiveness<br/>in ritual"]
    Forgive --> Summon["Summon soul<br/>back via cave"]
    Summon --> BH
...
```mermaid
flowchart TB
    Diff["Person born<br/>different<br/>(dwarf, disabled)"] --> Chosen["Interpreted as<br/>chosen by<br/>Mother Goddess"]
    Chosen --> Free["Freed from<br/>hunting duties"]
    Free --> Med["Full-time<br/>meditation &<br/>spirit-world access"]
    Med --> Shaman["Becomes<br/>Shaman"]
    Shaman --> Paint["Creates cave<br/>paintings"]
    Shaman --> Dress["Dresses as<br/>animals/birds"]
    Shaman --> Ritual["Leads religious<br/>rituals"]
    Dress --> Comm["Communicates<br/>with animals<br/>& spirit world"]
    Paint --> Shared["Shared religious<br/>experience for<br/>community"]
    style Diff fill:#2980b9,color:#fff
    style Shaman fill:#27ae60,color:#fff
...
```mermaid
flowchart TB
    Sym["Geometric Symbols<br/>(hand, spiral, circle,<br/>quadrangle, asterisk)"]
    Sym --> I1["Interpretation 1:<br/>Visual Shorthand"]
    Sym --> I2["Interpretation 2:<br/>Spirit-World Language"]
    Sym --> I3["Interpretation 3:<br/>Sacred Mystery"]
    I1 --> E1["Abstract ideas<br/>(energy, cycle, harmony)<br/>that cannot be drawn"]
    I2 --> E2["Psychedelics produce<br/>geometric visions --<br/>shamans recorded<br/>what they saw"]
    I3 --> E3["Symbols make content<br/>mysterious -- feels<br/>divine -- demands<br/>initiation"]
    style Sym fill:#2980b9,color:#fff
...
```mermaid
flowchart LR
    R["Religion<br/>(shared beliefs<br/>& myths)"] -->|"enables"| CT["Collective<br/>Thought<br/>(shared imagination)"]
    CT -->|"enables"| S["Society<br/>(community,<br/>culture, identity)"]
    S -->|"enables"| R
...
flowchart LR
    subgraph Marx
        M1["Human =<br/>Economic Animal"]
        M2["Driven by:<br/>material needs"]
        M1 --- M2
    end
    subgraph Darwin
        D1["Human =<br/>Biological Animal"]
        D2["Driven by:<br/>genes & reproduction"]
        D1 --- D2
    end
    subgraph Jiang["Prof. Jiang"]
        J1["Human =<br/>Religious Animal"]
        J2["Driven by:<br/>need for meaning"]
        J1 --- J2
    end
