...
tags: [lecture-summary, civilization, greece, aristotle, plato, philosophy, rationalism, empiricism, pan-hellenism, hellenistic, library-of-alexandria, ptolemy, seleucid, liberal-arts, greek-legacy, macedon]
...
```mermaid
flowchart TB
    P["ARISTOTLE<br/>The Paradox"]
    P --> X1["Paradox 1<br/>No original texts<br/>~200 works attributed but<br/>nothing personally written"]
    P --> X2["Paradox 2<br/>Impossible range<br/>Politics, poetics, ethics, rhetoric,<br/>physics, metaphysics, biology"]
    P --> X3["Paradox 3<br/>Opposed his teacher<br/>20 years under Plato<br/>yet directly contradicts him"]
    X1 --> Q["How is this possible<br/>for history's greatest thinker?"]
    X2 --> Q
    X3 --> Q
...
```mermaid
flowchart LR
    P["PLATO"] --- D1["Rationalist<br/>Truth through<br/>pure thought"]
    P --- D2["Dualist<br/>Body + Soul<br/>(soul matters)"]
    P --- D3["Eternity<br/>Immutable<br/>grand design"]
    A["ARISTOTLE"] --- D4["Empiricist<br/>Truth through<br/>observation"]
    A --- D5["Materialist<br/>Body / material<br/>world primary"]
    A --- D6["Infinity<br/>Everything mutable<br/>always in motion"]
    D1 -.- D4
    D2 -.- D5
    D3 -.- D6
    style P fill:#2980b9,color:#fff
...
```mermaid
flowchart TB
    subgraph PARALLEL["Parallel Lives — Aristotle & Philip II"]
        A1["384 BCE: Aristotle born<br/>Father = King's physician"] ~~~ P1["383 BCE: Philip born<br/>Father = King of Macedon"]
        A2["367–348 BCE<br/>Athens: Plato's Academy<br/>builds elite network"] ~~~ P2["369–365 BCE<br/>Thebes: military education<br/>under Greece's best generals"]
        A3["20-year network<br/>at Athens's Harvard-Oxford<br/>= perfect political middleman"] ~~~ P3["359 BCE: becomes King<br/>begins military campaign<br/>to conquer all of Greece"]
        A4["335 BCE: founds Lyceum<br/>3 years after Philip<br/>unites Greece"] ~~~ P4["338 BCE: unites Greece<br/>Battle of Chaeronea<br/>336 BCE: assassinated"]
    end
...
```mermaid
flowchart TB
    AE["Alexander dies 323 BCE<br/>Empire fragments"] --> F["Three successor kingdoms"]
    F --> ANT["Antigonid Empire<br/>(Macedonia / Greece)<br/>The Greek homeland"]
    F --> PT["Ptolemaic Egypt<br/>Strategy: cultural imposition<br/>Greek superiority enforced"]
    F --> SEL["Seleucid Empire<br/>Mesopotamia → Afghanistan<br/>Strategy: syncretisation"]
    PT --> B1["Stole Alexander's body<br/>from Babylon → Egypt"]
    PT --> B2["Founded Alexandria<br/>as new Greek capital"]
    PT --> B3["Founded the Museum<br/>world's first research university"]
    B3 --> LIB["Library of Alexandria<br/>standardise + disseminate<br/>Greek knowledge globally"]
    SEL --> SYN["Greek + Persian cultures<br/>coalesce into something new"]
    style AE fill:#e74c3c,color:#fff
    style LIB fill:#2980b9,color:#fff
...
```mermaid
flowchart TB
    P1["Paradox 1<br/>No original texts"] --> R1["Aristotle synthesised other thinkers' work<br/>and had students copy it —<br/>he wrote nothing original by design"]
    P2["Paradox 2<br/>Impossible range"] --> R2["He was capturing the entire<br/>Greek intellectual tradition —<br/>an encyclopaedia, not personal curiosity"]
    P3["Paradox 3<br/>Opposed his teacher"] --> R3["Plato's philosophy was politically useless<br/>for empire-builders — Aristotle's framework<br/>was engineered to serve Macedon"]
    R1 --> S["CENSOR THESIS<br/>All three paradoxes dissolve"]
    R2 --> S
    R3 --> S
...
```mermaid
flowchart TB
    H["HOMER<br/>Oral poetry<br/>Recites the Iliad"] --> HC["Capacity for<br/>Empathy + Imagination<br/>(entering another's world)"]
    PW["PLAYWRIGHTS<br/>Aeschylus, Sophocles,<br/>Euripides"] --> PC["Capacity for<br/>Perspective + Inner Debate<br/>(judging competing claims)"]
    PH["PHILOSOPHERS<br/>Plato, Aristotle"] --> PHC["Capacity for<br/>Reason + Reflection<br/>(pure thought on the page)"]
    HC --> NM["NEW HUMAN MIND<br/>Liberal Arts Education"]
    PC --> NM
    PHC --> NM
    NM --> T["Kant, Hume, Hegel<br/>All read the Greeks<br/>— that was their education"]
    style H fill:#e74c3c,color:#fff
    style PW fill:#2980b9,color:#fff
...
```mermaid
flowchart LR
    GK["Greek Knowledge<br/>(Aristotle's encyclopaedia)"] --> S1["+ Indian philosophy<br/>& religion"]
    GK --> S2["+ Jewish theology<br/>(Levant)"]
    GK --> S3["+ Egyptian traditions"]
    GK --> S4["+ Persian culture<br/>(Seleucid empire)"]
    S1 --> I1["New developments<br/>in Indian thought"]
    S2 --> CHR["CHRISTIANITY<br/>The world-changing<br/>syncretisation"]
    S3 --> I3["Greco-Egyptian<br/>cultural synthesis"]
    S4 --> I4["Seleucid hybrid<br/>civilisation"]
    style GK fill:#2980b9,color:#fff
    style CHR fill:#e74c3c,color:#fff
```
