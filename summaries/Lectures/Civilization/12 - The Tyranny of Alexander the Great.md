...
```mermaid
flowchart TB
    M["Father-Son Model<br/>(from Lecture 11)"]
    M --> P1["Prediction 1<br/>Aggressive expansion<br/>Reckless risk-taking"]
    M --> P2["Prediction 2<br/>Tyrannical rule<br/>Demands total obedience"]
    M --> P3["Prediction 3<br/>Boundless ambition<br/>Never stops conquering"]
    ...
    P3 --> V3["✅ Refused half the empire<br/>Planned Arabia after India<br/>Died before he could stop"]
...
```mermaid
flowchart TB
    PM["Philip II remarries<br/>Cleopatra Eurydice (338 BCE)"]
    PM --> C1["Eurydice is Macedonian<br/>Her son would be<br/>more legitimate than Alexander"]
    PM --> C2["Her relative Attalus<br/>insults Alexander at the wedding<br/>prays for a 'legitimate heir'"]
    C2 --> C3["Philip assassinated<br/>336 BCE"]
    C3 --> O["Olympias kills<br/>Eurydice, daughter,<br/>and infant son"]
    C3 --> A["Attalus fears<br/>for his life — prepares to rebel"]
    A --> PA["Parmenion faces<br/>a choice:<br/>Attalus or Alexander?"]
    PA -->|"Loyalty to Philip's memory"| K["Parmenion kills Attalus<br/>(his own son-in-law)"]
    K --> AK["Alexander becomes<br/>King of Macedon<br/>Age 20"]
...
```mermaid
flowchart TB
    subgraph Wrong["Conventional Metrics — Predict Persia Wins"]
        W1["Manpower<br/>(2:1 Persian advantage)"]
        W2["Technology<br/>(expensive Persian armour)"]
        W3["Wealth<br/>(vast Persian resources)"]
    end
    subgraph Right["Prof. Jiang's Metrics — Predict Macedon Wins"]
        R1["Cohesion<br/>Shared Macedonian culture<br/>vs. fragmented empire"]
        R2["Discipline<br/>30 years of Philip's warfare<br/>vs. peacetime imperial troops"]
        R3["Devotion<br/>Soldiers love their leaders<br/>vs. paid mercenaries"]
    end
    Wrong -->|"❌ Wrong prediction"| PW["Persia wins"]
    Right -->|"✅ Correct prediction"| MW["Macedon wins"]
...
```mermaid
flowchart LR
    E["Egypt falls without<br/>resistance (332 BCE)<br/>Egyptians hated Persia"]
    E --> T["Alexander travels to<br/>Temple of Zeus Ammon<br/>Siwa Oasis — weeks in the desert"]
    T --> R["Oracle reveals:<br/>Philip is NOT<br/>Alexander's real father"]
    R --> G["True father:<br/>Zeus Ammon<br/>Supreme God of the known world"]
    G --> D["Alexander is the<br/>Son of God<br/>like Heracles and Dionysus"]
    D --> PR["Demands proskynesis:<br/>foot-kissing from<br/>Macedonian soldiers"]
    PR --> RM["Philip's men furious:<br/>Alexander has renounced<br/>his own father"]
...
```mermaid
flowchart TB
    PH["Philip's Legacy:<br/>His Most Trusted Men"]
    PH --> PA["Parmenion<br/>Greatest general<br/>Kingmaker at succession"]
    PH --> CL["Cleitus the Black<br/>Saved Alexander's life<br/>at Granicus"]
    PH --> AN["Antipater<br/>Regent of Macedonia<br/>Philip's loyal general"]
    PA -->|"330 BCE — Executed<br/>on forced confession<br/>under torture"| D1["Dead"]
    CL -->|"328 BCE — Murdered<br/>Speared at banquet<br/>by Alexander himself"| D2["Dead"]
    AN -->|"323 BCE — Driven<br/>to conspiracy<br/>by Alexander's summons"| D3["Probable assassin<br/>of Alexander"]
    style PH fill:#2980b9,color:#fff
...
```mermaid
flowchart LR
    subgraph Persia["Invasion of Persia: Reasons"]
        P1["Wealth — vast empire"]
        P2["Security — Persia had invaded Greece"]
        P3["Revenge — possibly killed Philip"]
        P4["Known territory"]
    end
    subgraph India["Invasion of India: Reasons"]
        I1["Wealth — unknown"]
        I2["Security — no threat to Greece ever"]
        I3["Revenge — no grievance"]
        I4["Unknown geography and climate"]
    end
    Persia -->|"Rational strategic decision"| PW["✅ Strategic value"]
    India -->|"No rational justification"| IW["❌ Personal glory only"]
    style PW fill:#27ae60,color:#fff
    style IW fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart LR
    A["Alexander's Boundless Conquest<br/>Egypt, Persia, Afghanistan, Pakistan"]
    A --> U["Ungovernable empire<br/>No plan, no system"]
    U --> G["Generals must<br/>govern — need legitimacy"]
    G --> H["Invent and spread<br/>Greek Culture (Hellenism)"]
    H --> M["Greek culture merges<br/>with local traditions"]
    M --> J["Greek thought meets<br/>Judaism in the Levant"]
    J --> C["Christianity emerges<br/>from the fusion"]
