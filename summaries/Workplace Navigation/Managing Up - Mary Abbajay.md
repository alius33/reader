...
date: 2026-03-25
type: book-summary
tags: [book-summary, managing-up, manager-relationship, leadership, workplace-dynamics]
author: Mary Abbajay
title: "Managing Up: How to Move up, Win at Work, and Succeed with Any Type of Boss"
year: 2018
---
...
```mermaid
flowchart LR
    A[Dream Boss] --> B[Manageable]
    B --> C[Difficult but<br>Adaptable]
    C --> D[Damaging]
    D --> E[Truly Terrible]
...
```mermaid
flowchart LR
    A[Stay or Leave?] --> B{Sunk Costs}
    A --> C{Opportunity Costs}
    B --> D[Time, energy, political<br>capital already invested]
    D --> E[Irrecoverable —<br>should NOT factor in]
    C --> F[Growth, happiness,<br>health you are forgoing]
    F --> G[THIS is what matters]
    style E fill:#e74c3c,color:#fff
    style G fill:#27ae60,color:#fff
```
...
```mermaid
flowchart LR
    A[Diagnose] --> B[Anticipate]
    B --> C[Communicate<br>Proactively]
    C --> D[Deliver<br>Consistently]
    D --> E[Adapt<br>Continuously]
    E --> A
    style A fill:#2980b9,color:#fff
