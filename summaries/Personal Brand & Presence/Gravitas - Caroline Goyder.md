...
date: 2026-03-25
type: book-summary
tags: [book-summary, presence, communication, confidence, public-speaking, leadership, voice]
...
```mermaid
quadrantChart
    title Gravitas Double Bind
    x-axis Low Warmth --> High Warmth
    y-axis Low Authority --> High Authority
    quadrant-1 "Ideal Zone: Warm + Authoritative"
    quadrant-2 "Cold/Bossy stereotype"
    quadrant-3 "Invisible"
    quadrant-4 "Soft/Unserious stereotype"
```
