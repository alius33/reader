...
date: 2026-03-25
type: book-summary
tags: [book-summary, leadership, career, habits, executive-coaching, behaviour-change, feedback, taxonomy]
...
```mermaid
flowchart TD
    A["Early Career:<br>Technical skill +<br>competitive drive<br>= SUCCESS"] --> B["Promotion<br>to leadership"]
    B --> C["Same behaviours<br>at higher level"]
    C --> D{"Which behaviours<br>caused the success?"}
    D -->|"Superstition:<br>ALL of them"| E["Refuses to change<br>anything — including<br>the harmful habits"]
    D -->|"Reality:<br>SOME of them"| F["Identifies the harmful<br>ones and STOPS them"]
    E --> G["Career stalls<br>Relationships erode<br>Team disengages"]
    F --> H["Continued growth<br>Stronger relationships<br>Team thrives"]
...
```mermaid
flowchart TD
    subgraph EGO["Ego Habits"]
        H1["1. Winning<br>too much"]
        H2["2. Adding<br>too much value"]
        H3["3. Passing<br>judgment"]
        H6["6. Telling the world<br>how smart you are"]
        H11["11. Claiming<br>undeserved credit"]
    end
    subgraph COMM["Communication Habits"]
        H4["4. Destructive<br>comments"]
        H5["5. No/But/<br>However"]
        H7["7. Speaking<br>when angry"]
        H8["8. Negativity"]
    end
    subgraph CONTROL["Control Habits"]
        H9["9. Withholding<br>information"]
        H18["18. Punishing<br>the messenger"]
    end
    subgraph PROTECT["Self-Protection Habits"]
        H12["12. Making<br>excuses"]
        H13["13. Clinging<br>to the past"]
        H14["14. Playing<br>favourites"]
        H15["15. Refusing<br>to apologise"]
        H19["19. Passing<br>the buck"]
    end
    subgraph RELATE["Relationship Habits"]
        H10["10. Failing to<br>give recognition"]
        H16["16. Not<br>listening"]
        H17["17. Failing to<br>express gratitude"]
        H20["20. Excessive need<br>to be 'me'"]
    end
    H21["21. Goal<br>obsession"]
    EGO --> H21
    COMM --> H21
    CONTROL --> H21
    PROTECT --> H21
    RELATE --> H21
    style H21 fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart TD
    A["1. PICK ONE<br>behaviour to change"] --> B["2. ANNOUNCE IT<br>publicly to stakeholders"]
    B --> C["3. ASK FOR FEEDFORWARD<br>'What should I do differently?'"]
    C --> D["4. LISTEN<br>Say 'Thank you'<br>Nothing else"]
    D --> E["5. FOLLOW UP MONTHLY<br>'Am I getting better?'"]
    E --> F{"Stakeholders say YES?"}
    F -->|Yes| G["Behaviour change<br>is taking hold"]
    F -->|No| C
    G --> H["Pick the NEXT<br>behaviour to change"]
...
```mermaid
flowchart TD
    A["DIAGNOSE<br>360 feedback<br>Identify ONE habit"] --> B["COMMIT<br>Public declaration<br>Apologise"]
    B --> C["ACT<br>Monthly FeedForward<br>Monthly mini-survey"]
    C --> D["MEASURE<br>12-18 month re-survey"]
    D --> E{"Improvement<br>detected?"}
    E -->|"Yes"| F["Pick next habit<br>Repeat cycle"]
    E -->|"No"| G["Diagnose failure<br>Adjust approach<br>Restart"]
    style A fill:#2980b9,color:#fff
    style F fill:#27ae60,color:#fff
    style G fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart LR
    A["Week 1-2:<br>ENTHUSIASM<br>'I will change!'"] --> B["Week 3-8:<br>THE DIP<br>'Maybe the old<br>way was better'"]
    B --> C["Month 3-6:<br>INTEGRATION<br>'Becoming natural'"]
    C --> D["Month 6-12:<br>AUTOMATICITY<br>'This is who<br>I am now'"]
...
```mermaid
flowchart TD
    A["Brilliant Jerk<br>(1, 2, 3, 4, 6)"] --> D["Result:<br>Team stops<br>contributing"]
    B["Teflon Leader<br>(11, 12, 15, 19)"] --> E["Result:<br>Team stops<br>trusting"]
    C["Control Freak<br>(2, 9, 16, 18)"] --> F["Result:<br>Team routes<br>around leader"]
    D --> G["Leader becomes<br>isolated"]
    E --> G
    F --> G
    style G fill:#e74c3c,color:#fff
```
...
```mermaid
flowchart LR
    A["Leader seeks<br>feedback"] --> B["Stakeholders share<br>honestly"]
    B --> C["Leader says<br>'Thank you'"]
    C --> D["Trust<br>increases"]
    D --> E["Next round of<br>feedback is more<br>honest and specific"]
    E --> A
