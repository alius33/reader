...
date: 2026-03-25
type: book-summary
tags: [book-summary, social-skills, relationships, influence, communication, leadership, classic]
...
```mermaid
flowchart TD
    A["Core Drive: Every person<br>craves feeling important"] --> B["Path 1: Criticism"]
    A --> C["Path 2: Appreciation"]
    B --> D["Defensiveness"]
    D --> E["Resentment"]
    E --> F["Lost trust, lost cooperation"]
    C --> G["Feeling valued"]
    G --> H["Liking and trust"]
    H --> I["Willing cooperation"]
...
```mermaid
flowchart LR
    A["Principle 1:<br>Don't Criticise"] --> B["Principle 2:<br>Appreciate Sincerely"]
    B --> C["Principle 3:<br>Arouse Eager Want"]
    A --> D["Removes barriers"]
    B --> E["Builds connection"]
    C --> F["Creates motivation"]
    D --> G["Foundation:<br>People who trust you<br>and want to cooperate"]
    E --> G
    F --> G
...
```mermaid
flowchart LR
    A["What I want"] --> B{"Carnegie's Filter"}
    B --> C["What do THEY want?"]
    C --> D["How does what I want<br>serve what they want?"]
    D --> E["Frame request in<br>their terms"]
    E --> F["Eager cooperation"]
    style A fill:#e74c3c,color:#fff
...
```mermaid
flowchart TD
    A["Genuine Interest<br>(The Mindset)"] --> B["Smile"]
    A --> C["Remember Names"]
    A --> D["Listen Deeply"]
    A --> E["Talk About Their Interests"]
    A --> F["Make Them Feel Important"]
    B --> G["They Feel Liked"]
    C --> G
    D --> G
    E --> G
    F --> G
    G --> H["Trust & Connection"]
...
```mermaid
flowchart TD
    A["You want someone<br>to change their mind"] --> B{"Direct approach"}
    A --> C{"Carnegie approach"}
    B --> D["Tell them they're wrong"]
    D --> E["They defend their position"]
    E --> F["Ego is now invested"]
    F --> G["They dig in deeper"]
    C --> H["Avoid argument"]
    H --> I["See their viewpoint"]
    I --> J["Ask questions"]
    J --> K["They discover the<br>truth themselves"]
    K --> L["They own the<br>new position"]
...
```mermaid
flowchart LR
    A["Your idea"] --> B["Present as<br>finished product"]
    B --> C["Resistance:<br>'Not my idea'"]
    A --> D["Present as<br>rough concept"]
    D --> E["Ask for<br>their input"]
    E --> F["They shape it"]
    F --> G["Ownership:<br>'MY idea'"]
    G --> H["Enthusiastic<br>support"]
...
```mermaid
flowchart TD
    A["The Other Person's Ego"] --> B["Threatened"]
    A --> C["Respected"]
    B --> D["Defensiveness"]
    B --> E["Resentment"]
    B --> F["Entrenchment"]
...
```mermaid
flowchart TD
    A["Need to correct<br>someone's behaviour"] --> B["Begin with<br>genuine praise"]
    B --> C["Mention your<br>OWN mistakes first"]
    C --> D["Ask questions instead<br>of giving orders"]
    D --> E["Call attention to<br>errors indirectly"]
    E --> F["Let them<br>save face"]
    F --> G["Praise every<br>improvement"]
    G --> H["Give them a fine<br>reputation to live up to"]
    H --> I["Make them HAPPY<br>about the change"]
    style A fill:#2980b9,color:#fff
    style I fill:#27ae60,color:#fff
```
...
```mermaid
flowchart TD
    A["Part 1: Foundation<br>Don't criticise / Appreciate / Eager want"] --> B["Part 2: Liking<br>Interest / Smile / Names / Listen / Their interests / Importance"]
    B --> C["Part 3: Persuasion<br>Avoid arguments / Don't say 'wrong' / Admit mistakes / Friendly / Yes / Let them talk / Their idea / Viewpoint / Sympathy / Noble motives / Dramatise / Challenge"]
    C --> D["Part 4: Leadership<br>Praise first / Indirect / Own mistakes / Ask / Save face / Praise progress / Reputation / Encourage / Happy to comply"]
    A --> E["Foundation:<br>Stop pushing away"]
    B --> F["Connection:<br>Draw people in"]
    C --> G["Influence:<br>Change minds gently"]
    D --> H["Leadership:<br>Elevate people"]
...
```mermaid
flowchart LR
    A["Carnegie's Principles<br>(1936)"] --> B["Reciprocity"]
    A --> C["Consistency"]
    A --> D["Identity & Social Proof"]
    A --> E["Loss Aversion"]
    A --> F["Self-Determination"]
    A --> G["Cognitive Dissonance"]
    B --> H["Cialdini's Influence<br>(1984)"]
    C --> H
    D --> H
    E --> I["Kahneman's Research<br>(1979)"]
    F --> J["Deci & Ryan<br>(1985)"]
    G --> K["Festinger<br>(1957)"]
    style A fill:#2980b9,color:#fff
    style H fill:#27ae60,color:#fff
    style I fill:#27ae60,color:#fff
