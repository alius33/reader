...
date: 2026-03-25
type: book-summary
tags: [book-summary, influence, communication, language-patterns, persuasion, NLP, lab-profile, taxonomy]
author: Shelle Rose Charvet
title: "Words That Change Minds: Mastering the Language of Influence"
year: 1997
---
...
```mermaid
flowchart TD
    subgraph Cluster1["Drive & Initiative"]
        P1[Proactive / Reactive]
        P2[Toward / Away From]
    end
    subgraph Cluster2["Evaluation & Standards"]
        P3[Internal / External]
        P4[Criteria]
        P5[Rule Structure]
    end
    subgraph Cluster3["Decision Architecture"]
        P6[Options / Procedures]
        P7[Sameness / Difference]
        P8[Convincer Channel]
        P9[Convincer Mode]
    end
    subgraph Cluster4["Processing Style"]
        P10[Scope: Specific / General]
        P11[Attention: Self / Other]
        P12[Stress Response]
    end
    subgraph Cluster5["Work Environment"]
        P13[Style: Independent / Proximity / Co-operative]
        P14[Organisation: Person / Thing]
    end
    Cluster1 --> Profile[Complete LAB Profile]
    Cluster2 --> Profile
    Cluster3 --> Profile
    Cluster4 --> Profile
    Cluster5 --> Profile
    style Profile fill:#2980b9,color:#fff
```
...
```mermaid
flowchart LR
    A[Ask Diagnostic Question] --> B[Listen to Structure]
    B --> C[Identify Pattern]
    C --> D[Select Influencing Language]
    D --> E[Deliver Matched Message]
    E --> F[Resistance Dissolves]
...
```mermaid
flowchart LR
    subgraph MT["Motivation Traits"]
        direction TB
        M1["1. Proactive / Reactive"]
        M2["2. Criteria"]
        M3["3. Toward / Away From"]
        M4["4. Internal / External"]
        M5["5. Options / Procedures"]
        M6["6. Sameness / Difference"]
    end
    MT --> Q["What triggers and sustains this person's motivation?"]
...
```mermaid
flowchart LR
    subgraph WT["Working Traits"]
        direction TB
        W1["7. Scope"]
        W2["8. Attention Direction"]
        W3["9. Stress Response"]
        W4["10. Style"]
        W5["11. Organisation"]
        W6["12. Rule Structure"]
        W7["13. Convincer Channel"]
        W8["14. Convincer Mode"]
    end
    WT --> Q["How does this person process, decide, and work?"]
    style Q fill:#27ae60,color:#fff
```
...
```mermaid
flowchart LR
    A[Phase 1: Convincer Channel] --> B[Phase 2: Convincer Mode]
    B --> C[Conviction Triggered]
    A1[See] --> A
    A2[Hear] --> A
    A3[Read] --> A
    A4[Do] --> A
    B1[Number of Examples] --> B
    B2[Automatic] --> B
    B3[Consistent] --> B
    B4[Period of Time] --> B
...
```mermaid
flowchart TD
    A[Your Message] --> B{Profile the Listener}
    B --> C[Match Motivation Direction]
    B --> D[Match Evaluation Source]
    B --> E[Match Convincer Strategy]
    C --> F[Stack Matches into One Statement]
    D --> F
    E --> F
    F --> G[Irresistible Language]
    style A fill:#2980b9,color:#fff
...
```mermaid
flowchart TD
    A[Person feels stuck] --> B[List all Criteria]
    B --> C[Compare pairs: A vs B, A vs C, B vs C...]
    C --> D[Rank-ordered priority list]
    D --> E[Decision becomes obvious]
...
```mermaid
flowchart TD
    subgraph Motivation["Motivation Traits"]
        M1[Proactive / Reactive]
        M2[Criteria]
        M3[Toward / Away From]
        M4[Internal / External]
        M5[Options / Procedures]
        M6[Sameness / Difference]
    end
    subgraph Working["Working Traits"]
        W1[Scope: Specific / General]
        W2[Attention: Self / Other]
        W3[Stress: Feeling / Choice / Thinking]
        W4[Style: Independent / Proximity / Co-operative]
        W5[Organisation: Person / Thing]
        W6[Rule Structure]
        W7[Convincer Channel]
        W8[Convincer Mode]
    end
    Motivation --> Profile[Complete LAB Profile]
    Working --> Profile
    Profile --> IL[Irresistible Language]
    style Profile fill:#2980b9,color:#fff
