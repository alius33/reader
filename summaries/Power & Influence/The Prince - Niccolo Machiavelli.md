...
date: 2026-03-28
type: book-summary
tags: [book-summary, power, politics, leadership, strategy, classic, Machiavelli]
...
graph LR
    ...
    B -->|"Creates<br/>opportunities for"| A
...
graph TD
    ...
    C --> E["New"]
    E --> F["Entirely New"]
    E --> G["Mixed / Grafted<br/>(Ch 3-5)"]
    F --> H["By Own Virtù<br/>(Ch 6)<br/>Hard to get, easy to keep"]
    F --> I["By Others' Fortuna<br/>(Ch 7)<br/>Easy to get, hard to keep"]
    F --> J["By Wickedness<br/>(Ch 8)<br/>Neither virtù nor fortuna"]
    F --> K["By Popular Support<br/>(Ch 9)<br/>Civil principality"]
    G --> L["Same Language<br/>Easy — just destroy<br/>old ruling family"]
    G --> M["Different Language<br/>Hard — relocate,<br/>colonise, or fail"]
...
graph TD
    ...
    A --> E["<b>MIXED</b><br/>Some combination"]
    B -->|"✓ Reliable, loyal,<br/>invested in outcome"| F["SECURE"]
    C -->|"✗ Disloyal, cowardly,<br/>only care about pay"| G["DOOMED"]
    D -->|"✗ Obey someone else,<br/>disaster ready-made"| G
    E -->|"Better than pure<br/>mercenary/auxiliary,<br/>worse than own"| H["UNSTABLE"]
...
graph LR
    ...
    subgraph "STORM"
        B["Fortuna Strikes<br/>(War, Crisis,<br/>Invasion, Betrayal)"]
    end
    subgraph "OUTCOME"
        C["Prepared Prince:<br/>Survives, Adapts"]
        D["Unprepared Prince:<br/>Swept Away"]
    end
    A -->|"Dykes hold"| C
    B -->|"No defences"| D
    B -->|"Defences built"| C
